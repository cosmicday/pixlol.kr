...
const KNOWN_OK = new Map([
    ...
    // 2026-08-24 — 돌진기인데 bin 이 속도를 투사체 칸(legacy missileSpeed/spec)에 들고 있던 자리. 트리스타나 W 와 같은 모양
    ['말파이트 R', '돌진 속도 1500 (+ 이동 속도의 100%) 는 롤위키 손표 — legacy 700 은 기절 이펙트 값이라 뺐다'],
    ['자크 E', '돌진 속도 1350 은 롤위키 손표 — legacy 1500 은 투사체 칸에 잘못 실려 있었다'],
    ['탈론 Q', '돌진 속도 2000 은 본체 spec 손표 — 대상에게 뛰어드는 돌진이라 투사체 칸에서 옮겼다'],
