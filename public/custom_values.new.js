...
const customValues = {
    ...
    "Sylas": { // 사일러스
        ...
        "R": {
            "p1": "80 / 55 / 30 x 200", // PerTargetCooldown
    ...
    "Ashe": { // 애쉬
        ...
        "E": {
            "p1": "5 x 90 / 80 / 70 / 60 / 50", // ChargeCooldown
            "v1": "", // 구분선 아래 피해량 줄 (직접 작성)
            "v2": "",
            "cooldown": "5",
            "cost": "-",
    ...
    "Udyr": { // 우디르
        ...
        "Q": {
            ...
            "p8": "주문력의 0.006% + 0.015 ~ 0.03 (레벨에 따라) x 1%", // EmpoweredLightningBonusMax
            "v1": "", // 구분선 아래 피해량 줄 (직접 작성)
            "v2": "",
            "cooldown": "6",
            "cost": "20",
    ...
    "Yuumi": { // 유미
        ...
        "R": {
            ...
            "p8": "30 / 50 / 70 (+ 주문력의 12%) x 1.3 ~ 1.3 (레벨에 따라)", // EnhancedHealPerWave
            "v1": "", // 구분선 아래 피해량 줄 (직접 작성)
            "v2": "",
            "cooldown": "120 / 110 / 100",
            "cost": "100",
    ...
    "Katarina": { // 카타리나
        ...
        "E": {
            ...
            "p2": "0.78 ~ 1 (레벨에 따라) x 12 / 11 / 10 / 9 / 8 x 12 / 11 / 10 / 9 / 8", // DaggerCooldownReduction
