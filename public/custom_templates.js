...
// 생성 시각: 2026-08-10T09:16:47.791Z
...
const customTemplates = {
    ...
    "Kaisa": { // 카이사
        ...
        //   0번은 스킬 본체(기본 아이콘), 1번부터 values.icons[i-1] 과 짝이 된다.
        "W": [
            "카이사가 공허 에너지 광선을 발사해 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 <keywordmajor>플라즈마</keywordmajor> 중첩을 {p2}회 적용하며, {p3}초 동안 처음으로 적중한 적에 대한 <keywordstealth>절대 시야</keywordstealth>를 얻습니다.<br><keywordmajor>진화 시</keywordmajor>: <keywordmajor>플라즈마</keywordmajor> 중첩을 {p4}회 적용합니다. 챔피언 적중 시 재사용 대기시간이 {p5}% 감소합니다.",
            "진화 조건: <scaleap>주문력 {p7}</scaleap>"
        ], // 공허추적자 — "현재: {p6}/{p7}" 에서 현재값 제거
        // ★ 배열 = 하위 스킬을 파트로 쪼개 눈 것. app.js 가 아이콘 + 구분선으로 나눠 그린다.
        //   0번은 스킬 본체(기본 아이콘), 1번부터 values.icons[i-1] 과 짝이 된다.
        "E": [
            "카이사가 공허 에너지를 고속 충전하여 <speed>이동 속도가 {p1}</speed> 증가하고 충전 중에는 유체화 상태가 되며, {p2}초 동안 <attackspeed>공격 속도가 {p3}%</attackspeed> 증가합니다.<br>기본 공격 시 스킬의 재사용 대기시간이 {p4}초 감소합니다.<br><keywordmajor>진화 시</keywordmajor>: {p5}초 동안 <keywordstealth>투명</keywordstealth> 상태가 됩니다.",
            "진화 조건: <attackspeed>추가 공격 속도 {p7}%</attackspeed>"
