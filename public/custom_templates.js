...
const customTemplates = {
    "Garen": { // 가렌
        ...
        "E": "가렌이 {p1}초 동안 검을 들고 빠르게 회전하여 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 {p3}회 입힙니다. <attackspeed>추가 공격 속도</attackspeed> 25%당 공격 횟수가 1회 증가합니다. 가장 가까운 적을 대상으로는 <physicaldamage>피해량이 {p4}% 증가</physicaldamage>합니다. 공격에 {p5}번 맞은 챔피언은 {p6}초 동안 <scalearmor>방어력이 {p7}%</scalearmor> 감소합니다.<br><br><recast>재사용 시</recast>: 이 스킬을 일찍 종료합니다.", // 심판
    ...
    "Aphelios": { // 아펠리오스
        "P": "아펠리오스는 쌍둥이 누이 알룬이 만든 다섯 가지의 루나리 무기를 사용합니다. 한 번에 <b>주 무기</b>와 <b>보조 무기</b> 등 총 두 가지 무기를 사용할 수 있습니다. 각 무기는 고유의 기본 공격 및 [Q] 스킬을 가지고 있습니다.<br><br>각 무기에는 달빛 탄약이 <b>50</b>발씩 있으며 기본 공격과 [Q] 스킬 사용 시 소모합니다. 탄약을 모두 소모하면 그 무기는 대기열 맨 뒤로 이동하고, 다음 무기가 주 무기가 됩니다.<br><br>2레벨 도달 시 [Q] 스킬을 사용할 수 있으며 6레벨 도달 시 궁극기를 사용할 수 있습니다. 아펠리오스는 스킬 포인트로 스킬 레벨을 올리는 대신 영구 능력치를 획득합니다.<br><br><passive>무기별 기본 공격:</passive><li><b><i><font color='#00e6b8'>만월총</font></i></b>(소총): 공격 사거리가 <b>100</b> 증가합니다. 스킬에 맞은 적에게 <b>4.5</b>초 동안 표식을 남기며, 표식이 남은 적은 <b>1800</b> 사거리에서 보조 무기로 공격할 수 있습니다. 표식을 소모할 때마다 <physicaldamage>15 (+ 추가 공격력의 15%)의 추가 물리 피해</physicaldamage>를 입힙니다.</li><li><b><i><font color='#e6005c'>절단검</font></i></b>(낫 모양 권총): 입힌 피해량의 <healing>2 ~ 7.1% (레벨에 따라)</healing>만큼 체력을 회복합니다. (스킬로 입힌 피해는 <healing>5 ~ 17.75%</healing>) 체력이 가득 차 있으면 초과분이 <shield>10 ~ 160 (레벨에 따라) (+ 최대 체력의 6%)의 보호막</shield>이 됩니다.</li><li><b><i><font color='#a64dff'>중력포</font></i></b>(대포): 적을 <b>2.5</b>초 동안 <status>30% 둔화</status>시킵니다. <b>0.7</b>초 후 <b>10%</b>로 감소합니다.</li><li><b><i><font color='#1a75ff'>화염포</font></i></b>(화염 방사기): 첫 대상에게 <physicaldamage>총 공격력의 110%</physicaldamage>, 그 뒤 부채꼴 범위의 적에게 <physicaldamage>75 ~ 100% (레벨에 따라)</physicaldamage>의 피해를 입힙니다. (미니언은 <b>23 ~ 30%</b>)</li><li><b><i><font color='#ffffcc'>반월검</font></i></b>(투척 무기): 반월검을 던지고 돌아올 때까지 공격할 수 없습니다. 돌아오지 않은 반월검이 쌓일수록 공격력이 증가합니다. (최대 <b>20</b>개, <physicaldamage>총 공격력의 138.5%</physicaldamage>까지)</li>", // 암살자와 예언자 — 무기 5종 설명으로 재작성 (2026-08-09). stringtable 원문의 "루나리 무기 순서" 블록은 현재 상태값이라 뺐다
        "Q": "사용 중인 <b>주 무기</b>에 따라 다른 스킬을 사용합니다. 모든 [Q] 스킬은 달빛 탄약 <b>10</b>발과 <scalemana>마나 60</scalemana>을 소모합니다.<br><li><b><i><font color='#00e6b8'>만월총</font></i></b> — <spellname>달빛탄</spellname>: 지정한 방향으로 에너지 화살을 발사해 처음 맞은 적에게 <physicaldamage>70 ~ 160 (레벨에 따라) (+ 추가 공격력의 42 ~ 60% + 주문력의 100%)의 물리 피해</physicaldamage>를 입히고 표식을 남깁니다. (재사용 대기시간 <b>10 ~ 8</b>초, 사거리 <b>1450</b>)</li><li><b><i><font color='#e6005c'>절단검</font></i></b> — <spellname>맹공</spellname>: <b>1.75</b>초 동안 <speed>이동 속도가 25% (+ 주문력 100당 10%)</speed> 증가하며 가장 가까운 적을 주 무기와 보조 무기로 자동 공격합니다. 공격 한 번당 <physicaldamage>총 공격력의 20 ~ 41% (레벨에 따라)</physicaldamage>의 피해를 입힙니다. (<b>6</b>회 + <attackspeed>추가 공격 속도</attackspeed> 100%당 <b>2</b>회, 재사용 대기시간 <b>10 ~ 8</b>초)</li><li><b><i><font color='#a64dff'>중력포</font></i></b> — <spellname>월식</spellname>: <b><i><font color='#a64dff'>중력포</font></i></b>에 <status>둔화</status>된 모든 적에게 <magicdamage>50 ~ 140 (레벨에 따라) (+ 추가 공격력의 32 ~ 50% + 주문력의 70%)의 마법 피해</magicdamage>를 입히고 <b>1</b>초 동안 <status>속박</status>시킵니다. 거리 제한이 없습니다. (재사용 대기시간 <b>12 ~ 10</b>초)</li><li><b><i><font color='#1a75ff'>화염포</font></i></b> — <spellname>황혼파</spellname>: <b>40°</b> 부채꼴 범위에 에너지 파동을 날려 <physicaldamage>20 ~ 110 (레벨에 따라) (+ 추가 공격력의 15 ~ 21% + 주문력의 70%)의 물리 피해</physicaldamage>를 입힌 뒤, 맞은 적 전원을 보조 무기로 공격해 <physicaldamage>총 공격력의 100%</physicaldamage>의 피해를 입힙니다. (재사용 대기시간 <b>9 ~ 6</b>초, 사거리 <b>650</b>)</li><li><b><i><font color='#ffffcc'>반월검</font></i></b> — <spellname>파수탑</spellname>: 달의 파수탑을 설치합니다. 파수탑은 보조 무기를 복제해 가장 가까운 적을 <b>4</b>초 동안 공격하며, 공격 한 번당 <physicaldamage>35 ~ 125 (레벨에 따라) (+ 추가 공격력의 34 ~ 52% + 주문력의 50%)</physicaldamage>의 피해를 입힙니다. <b>20</b>초 동안 유지됩니다. (설치 사거리 <b>475</b>, 재사용 대기시간 <b>9 ~ 6</b>초)</li>", // 무기 스킬 — 무기별 Q 5종으로 재작성 (2026-08-09)
        "W": "주 무기와 보조 무기를 교체하여 장착합니다.", // 위상 변화
        // ★ null = "이 챔피언에겐 이 키가 없다". app.js 가 스킬 목록에서 통째로 뺀다.
        //   아펠리오스는 E 키를 안 쓴다 (무기 교체가 탄약 소진으로 자동 진행).
        //   "" 는 "아직 안 씀"(폴백) 이라 뜻이 다르니 헷갈리지 말 것.
        "E": null,
        "R": "챔피언에게 적중 시 폭발하는 달빛 에너지를 발사하여 주변 적에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다.<br><br>폭발 <b>0.3</b>초 후 적중한 모든 챔피언에게 하늘에서 공격이 쏟아져 <physicaldamage>총 공격력의 100%</physicaldamage>의 피해를 입히며, <onhit>적중 시</onhit> 효과가 적용됩니다.<br><br><passive>주 무기에 따른 추가 효과:</passive><li><b><i><font color='#00e6b8'>만월총</font></i></b>: 강화된 표식을 남깁니다. 표식을 소모할 때마다 <physicaldamage>50 / 80 / 110의 추가 물리 피해</physicaldamage>를 입힙니다.</li><li><b><i><font color='#e6005c'>절단검</font></i></b>: 적 챔피언을 한 명 이상 맞히면 <healing>체력을 250 / 350 / 450</healing> 회복합니다.</li><li><b><i><font color='#a64dff'>중력포</font></i></b>(대포): <status>둔화</status> 효과가 <b>99%</b>까지 증가하고, 이 둔화에 걸린 적은 <spellname>월식</spellname>으로 <b>1.35</b>초 동안 <status>속박</status>됩니다.</li><li><b><i><font color='#1a75ff'>화염포</font></i></b>: 최초 폭발이 <physicaldamage>50 / 100 / 150 (+ 추가 공격력의 25%)의 추가 물리 피해</physicaldamage>를 입힙니다. 이후 공격이 대상마다 <b>400</b> 범위로 퍼집니다.</li><li><b><i><font color='#ffffcc'>반월검</font></i></b>: 처음 맞힌 적 챔피언에게서 반월검 <b>5</b>개가 추가로 돌아옵니다. (총 <b>6</b>개)</li>", // 월광포화 — 주 무기별 추가 효과 5종 추가 (2026-08-09, 롤위키)
    },
    "Alistar": { // 알리스타
