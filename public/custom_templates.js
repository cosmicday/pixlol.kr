...
// 생성 시각: 2026-08-08T07:14:21.895Z
...
const customTemplates = {
    "Garen": { // 가렌
        ...
        "E": "가렌이 {p1}초 동안 검을 들고 빠르게 회전하여 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 {p3}회 입힙니다. 가장 가까운 적을 대상으로는 <physicaldamage>피해량이 {p4}% 증가</physicaldamage>합니다. 공격에 {p5}번 맞은 챔피언은 {p6}초 동안 <scalearmor>방어력이 {p7}%</scalearmor> 감소합니다.<br><br><recast>재사용 시</recast>: 이 스킬을 일찍 종료합니다.", // 심판
    ...
    "Gangplank": { // 갱플랭크
        ...
        "Q": "{{Spell_GangplankQWrapper_Tooltip_{p1}}}", // 혀어어어업상
    ...
    "Gragas": { // 그라가스
        ...
        "Q": "그라가스가 술통을 굴립니다. 술통은 {p1}초 후 폭발해 <magicdamage>{p2}</magicdamage>~<magicdamage>{p3}의 마법 피해</magicdamage>를 입히고 {p4}초 동안 {p5}~{p6}% <status>둔화</status>시킵니다. 피해량과 <status>둔화</status> 효과는 폭발 전 술통이 유지됐던 시간에 비례해 증가합니다. <br><br><recast>재사용</recast>하여 술통을 더 빨리 폭발시킬 수 있습니다.", // 술통 굴리기
    ...
    "Gwen": { // 그웬
        ...
        "R": "<active>첫 번째 사용:</active> 바늘을 던져 적중한 모든 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고, {p2}초 동안 {p3}% <status>둔화</status>시키며, <spellname>가위 난도질</spellname>을 적용합니다. 이 스킬은 6초 안에 최대 2회까지 추가로 <recast>재사용</recast>할 수 있습니다. (추가 재사용 대기시간 {p4}초)<br><br><recast>두 번째 사용:</recast> 바늘을 세 개 발사하여 <magicdamage>{p5}의 마법 피해</magicdamage>를 입힙니다.<br><recast>세 번째 사용:</recast> 바늘을 다섯 개 발사하여 <magicdamage>{p6}의 마법 피해</magicdamage>를 입힙니다.", // 바느질
    },
    "Gnar": { // 나르
    ...
    "Nasus": { // 나서스
        "P": "나서스가 @Spell.NasusPassive:LifestealTooltip@%의 추가 생명력 흡수 효과를 얻습니다.", // 영혼의 포식자 — stringtable
    ...
    "Nunu": { // 누누와 윌럼프
        ...
        "W": "누누와 윌럼프가 굴릴수록 크기와 속도가 증가하는 눈덩이를 생성합니다. 눈덩이는 적에게 피해를 입히고 공중으로 띄워 올립니다. 눈덩이를 굴리는 동안 회전 속도가 느려지지만 계속 회전하면 회전 속도가 점점 증가합니다.<br><br>눈덩이가 챔피언이나 대형 몬스터, 벽에 충돌하면 <magicdamage>{p1}</magicdamage>~<magicdamage>{p2}의 마법 피해</magicdamage>를 입히고 {p3}~{p4}초 동안 대상을 <status>공중으로 띄워 올립니다</status>. 피해량은 눈덩이를 굴린 거리에 비례합니다.<br><br><recast>재사용</recast>하여 눈덩이를 일찍 굴려 보낼 수 있습니다.", // 데굴데굴 눈덩이!
        ...
        "R": "누누와 윌럼프가 최대 {p1}초 동안 강력한 눈보라를 생성합니다. 눈보라 안에 있는 적은 {p2}% <status>둔화</status>되며 지속시간 동안 둔화 정도는 최대 {p3}%까지 증가합니다. 누누와 윌럼프는 <shield>{p4}의 보호막</shield>을 얻으며, 이 보호막은 이후 {p5}초에 걸쳐 서서히 사라집니다.<br><br>눈보라가 끝나면 폭발하여 범위 내에 있는 적에게 정신 집중 시간에 비례해 최대 <magicdamage>{p6}의 마법 피해</magicdamage>를 입힙니다. <recast>재사용</recast>하여 눈보라를 일찍 끝낼 수 있습니다.", // 절대 영도
    },
    "Nidalee": { // 니달리
        "P": "니달리는 <spellname>쿠거의 상</spellname> 스킬 레벨을 하나 보유한 상태로 시작합니다. <br><br>수풀에 들어가면 2초 동안 니달리의 <speed>이동 속도가 @spell.AspectOfTheCougar:PassivePercentMS@%</speed> 증가합니다. 적 챔피언 쪽으로 이동할 때는 <speed>이동 속도가 @spell.AspectOfTheCougar:PassivePercentMS*3@%</speed>까지 증가합니다.<br><br>챔피언이나 정글 몬스터가 <spellname>창 투척</spellname>이나 <spellname>매복 덫</spellname>에 적중하면 4초 동안 <keywordmajor>사냥</keywordmajor> 대상이 됩니다. <keywordmajor>사냥</keywordmajor>당하는 적이 있으면 <keywordstealth>절대 시야</keywordstealth>로 해당 적의 모습이 드러나며 니달리의 <speed>이동 속도가 @spell.AspectOfTheCougar:PassivePercentMS@%</speed> 증가합니다. <keywordmajor>사냥</keywordmajor>당하는 적 쪽으로 이동할 때는 <speed>이동 속도가 @spell.AspectOfTheCougar:PassivePercentMS*3@%</speed>까지 증가합니다.", // 수풀 배회 — stringtable
    ...
    "Neeko": { // 니코
        ...
        "W": "<passive>기본 지속 효과:</passive> 세 번째 기본 공격마다 <magicdamage>{p1}의 추가 마법 피해</magicdamage>를 입히고 {p2}초 동안 <speed>이동 속도가 {p3}%</speed> 증가합니다.<br><br><active>사용 시:</active> 니코가 {p4}초 동안 <keywordstealth>투명</keywordstealth> 상태가 되며 {p5}초 동안 유지되는 복제 형상을 만들어 지정한 방향으로 보냅니다. 니코와 복제 형상은 {p6}초 동안 <speed>{p7}%의 추가 이동 속도</speed>를 얻습니다. <br><br><rules>클릭하여 소환수 이동 단축키를 사용하거나 이 스킬을 <recast>재사용</recast>해 분신을 조종할 수 있습니다.<br>분신은 니코의 스킬, 감정표현, 귀환을 따라 합니다.</rules>", // 형상 분리
    ...
    "Nilah": { // 닐라
        ...
        "R": "칼날 채찍을 휘둘러 1초 동안 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힌 다음 마지막 일격으로 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입히고 적을 자신 쪽으로 <status>끌어당깁니다</status>.<br><br>적 챔피언에게 <healing>입힌 피해의 {p3}(+@spell.NilahQ:CritLifesteal@ 무형의 검)</healing>만큼 자신과 주변 아군을 회복시키며, 최대 체력을 초과한 회복량은 {p4}초 동안 지속되는 <shield>보호막</shield>으로 전환됩니다.", // 환희
    },
    "Darius": { // 다리우스
    ...
    "Draven": { // 드레이븐
        "P": "드레이븐이 챔피언이 아닌 유닛을 처치하거나, 포탑을 파괴하거나, <keywordmajor>회전 도끼</keywordmajor>를 잡을 때마다 중첩을 {p1} 획득합니다.<br><br>드레이븐이 챔피언을 처치할 때마다 {p2}+중첩당 {p3}골드를 추가로 획득합니다. 드레이븐이 사망하면 중첩 중 {p4}%가 사라집니다.<br><br>획득한 총 골드: <stattracking>{p5}</stattracking><br>최고 골드 획득량: <stattracking>{p6}</stattracking>", // 드레이븐의 리그 — stringtable
    ...
    "Rakan": { // 라칸
        ...
        "E": "라칸이 아군 챔피언에게 도약해 {p1}초 동안 <shield>{p2}의 피해를 흡수하는 보호막</shield>을 씌웁니다.<br><br>라칸은 {p3}초 안에 이 스킬을 <recast>재사용</recast>할 수 있습니다.", // 전쟁무도
    ...
    "Rammus": { // 람머스
        ...
        "R": "람머스가 공중으로 뛰어오른 후 지점에 착지하여 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다. <spellname>대회전</spellname> 중에 사용했다면 중앙에 있는 적들은 추가로 <magicdamage>@spell.PowerBall:PowerBallDamage@의 마법 피해</magicdamage>를 입고 {p4}초 동안 <status>공중에 뜹니다</status>.<br><br>이후 {p5}초 동안 해당 지점에 여진이 {p6}회 발생하며 <status>둔화</status> 효과를 중첩합니다.<br><br>이 스킬의 범위는 람머스의 <speed>이동 속도</speed>에 따라 증가합니다.", // 지진 폭격
    },
    "Lux": { // 럭스
    ...
    "Renata": { // 레나타 글라스크
        ...
        "Q": "레나타 글라스크가 의수에서 미사일을 발사해 처음 적중하는 적을 {p1}초간 <status>속박</status>하고 <magicdamage>{p2}</magicdamage>의 <magicdamage>마법 피해</magicdamage>를 입힙니다.<br><br><recast>재사용 시:</recast> 레나타가 대상을 지정한 방향으로 <status>던져</status> 적중하는 적에게 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다. 챔피언을 던진 경우 적중하는 적을 {p3}초간 <status>기절</status>시킵니다.", // 악수
    ...
    "Renekton": { // 레넥톤
        ...
        "E": "레넥톤이 돌격하며 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다. 챔피언이 아닌 대상을 맞힐 때는 <keywordmajor>{p2}의 분노</keywordmajor>가, 챔피언을 맞힐 때는 <keywordmajor>{p3}의 분노</keywordmajor>가 생성됩니다. 한 명 이상의 적에게 피해를 입힐 경우 {p4}초 내에 이 스킬을 한 번 <recast>재사용</recast>할 수 있습니다. <br><br><keywordmajor>분노 추가 효과</keywordmajor>: <recast>재사용</recast> 시 레넥톤이 돌격하며 <physicaldamage>{p5}의 물리 피해</physicaldamage>를 입히고 {p6}초 동안 방어력을 <scalearmor>{p7}%</scalearmor> 감소시킵니다. 더 이상 <keywordmajor>분노</keywordmajor>가 생성되지 않습니다.", // 자르고 토막내기
    ...
    "Rengar": { // 렝가
        "P": "수풀에서 기본 공격을 사용하면 대상에게 도약합니다.<br><br>궁극기 이외의 스킬을 사용하면 <keywordmajor>1회의 야성</keywordmajor> 중첩을 얻습니다. 도약 시작 시 현재 도약으로 얻은 야성이 없을 경우 보이지 않는 포식자가 <keywordmajor>1회의 야성</keywordmajor> 중첩을 생성합니다.<br> <br><keywordmajor>야성 {p1}회 중첩</keywordmajor> 시 다음에 사용하는 궁극기 이외의 스킬이 강화되고, 강화된 스킬 사용 시 {p2}초 동안 <speed>이동 속도가 {p3}</speed> 증가합니다.<br><br><keywordmajor>뼈이빨 목걸이</keywordmajor>의 고유 처치로 렝가의 <physicaldamage>공격력</physicaldamage>이 증가합니다.", // 보이지 않는 포식자 — stringtable
        "Q": "다음 2회 기본 공격 시 렝가의 <attackspeed>공격 속도가 {p1}%</attackspeed> 증가합니다. 첫 번째 공격은 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다.<br><br><keywordmajor>최대 야성:</keywordmajor> 첫 번째 공격이 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 입히고 {p4}초 동안 렝가의 <attackspeed>공격 속도가 {p5}</attackspeed> 증가합니다.", // 포악함
        "W": "렝가가 포효하여 근처 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 지난 {p2}초 동안 입은 피해의 <healing>{p3}%</healing>를 회복합니다.<br><br><keywordmajor>최대 야성:</keywordmajor> <magicdamage>{p4}의 마법 피해</magicdamage>를 입히고 추가로 군중 제어 효과를 해제합니다.", // 전투의 포효
        "E": "렝가가 올가미를 던져 처음으로 맞힌 적의 위치를 드러낸 다음 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다.<br><br><keywordmajor>최대 야성:</keywordmajor> <physicaldamage>{p4}의 물리 피해</physicaldamage>를 입히고 {p2}초 동안 <status>속박</status>합니다.", // 올가미 투척
    ...
    "Locke": { // 로크
        ...
        "W": "로크가 자신의 영혼을 불태워 <attackspeed>공격 속도가 {p1}</attackspeed>, <speed>이동 속도가 {p2}</speed> 증가했다가 {p3}초에 걸쳐 원래대로 돌아옵니다.<br><br>{p4}초 동안 매초 <truedamage>현재 체력의 {p5}%에 해당하는 고정 피해</truedamage>를 입지만, 마지막으로 입은 피해량 <healing>{p6}</healing>만큼 <healing>체력을 회복</healing>하고, 잃은 체력 및 경과 시간에 비례해 <healing>{p7}의 체력</healing>을 추가로 회복합니다. 최대 <healing>남은 체력의 {p8}만큼 회복</healing>합니다.<br><br><recast>재사용</recast>하여 더 빨리 종료할 수 있습니다.", // 영혼 점화
        "E": "로크가 지정한 위치로 순간이동하며 주변 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다. <br><br>다음 기본 공격 시 대상에게 돌진하며 경로에 있는 모든 적에게 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다. 적중할 때마다 <keywordmajor>영혼의 대못</keywordmajor>을 소모합니다.<br><br>로크가 처치에 관여하면, 이 스킬의 재사용 대기시간이 초기화됩니다.", // 잿빛 추격
    ...
    "Leblanc": { // 르블랑
        ...
        "W": "르블랑이 돌진한 후 주변 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다. 돌진 후 {p2}초 동안 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 르블랑이 처음 위치로 돌아갑니다.", // 왜곡
        ...
        "R": "르블랑이 가장 최근에 사용한 스킬을 모방하여 다시 사용합니다. 모방한 스킬의 피해량이 증가합니다.<br><br><spellname>모방한 악의의 인장</spellname>을 남기면 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고, 발동하면 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다.<br><spellname>모방한 왜곡</spellname>은 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다.<br><spellname>모방한 환영 사슬</spellname>은 옭아맬 때 <magicdamage>{p4}의 마법 피해</magicdamage>를 입히고, <status>속박</status>할 때 <magicdamage>{p5}의 마법 피해</magicdamage>를 입힙니다.", // 모방
    },
    "LeeSin": { // 리 신
        ...
        "Q": "리 신이 불협화음으로 된 음파를 발사하여 처음 적중한 적에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히고 해당 적에 대한 <keywordstealth>절대 시야</keywordstealth>를 얻습니다. 다음 {p2}초 안에 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 리 신이 음파에 맞은 적에게 돌진하여 대상이 잃은 체력에 비례해 <physicaldamage>{p3}~{p4}의 물리 피해</physicaldamage>를 입힙니다.", // 음파 / 공명의 일격
        "W": "리 신이 아군이나 와드를 향해 돌진합니다. 대상이 챔피언일 경우 해당 아군과 자신에게 {p1}초 동안 <shield>{p2}의 피해를 흡수하는 보호막</shield>을 씌웁니다. {p3}초 안에 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> {p4}초 동안 모든 피해 흡혈이 {p5}% 증가합니다.", // 방호 / 강철의 의지
        "E": "리 신이 바닥을 내리쳐 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 은신한 적을 드러내는 충격파를 발생시킵니다. 스킬이 적에게 명중하면 다음 {p3}초 안에 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 충격파에 적중한 주변 적을 {p4}% <status>둔화</status>시킵니다. 둔화 효과는 {p2}초에 걸쳐 사라집니다.", // 폭풍/무력화
    ...
    "Riven": { // 리븐
        ...
        "R": "리븐의 검이 정신력으로 충만하여 {p1}초 동안 <physicaldamage>공격력이 {p2}</physicaldamage> 상승하고 공격 스킬과 기본 공격의 사거리가 증가합니다. 활성화된 동안 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 바람 가르기를 사용해 대상이 잃은 체력에 비례하여 <physicaldamage>{p3}</physicaldamage>~<physicaldamage>{p4}의 물리 피해</physicaldamage>를 입힙니다.", // 추방자의 검
    },
    "Lissandra": { // 리산드라
    ...
    "Mel": { // 멜
        "P": "멜이 기본 공격과 스킬로 피해를 입힐 때마다 {p1}초 동안 <keywordmajor>압도</keywordmajor> 중첩을 적용하고 초기화하여 <magicdamage>@spell.MelR:PassiveFlatDamage@+중첩당 @spell.MelR:PassiveStackDamage@의 마법 피해</magicdamage>를 비축합니다. 적용 시, 비축한 피해량이 적의 보호막과 체력을 합친 것보다 크면 적이 처형됩니다.<br><br>스킬을 사용하면 멜이 다음 기본 공격 시 {p2}개의 추가 투사체를 발사하며 개당 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다. 이 효과로 추가할 수 있는 투사체는 최대 {p4}개입니다.", // 이글거리는 광휘 — stringtable
    ...
    "Mordekaiser": { // 모데카이저
        ...
        "W": "<passive>기본 지속 효과:</passive> 모데카이저가 입히는 피해의 {p1}%, 받는 피해의 {p2}%를 축적합니다.<br><br><active>사용 시:</active> 모데카이저가 축적한 피해를 <shield>보호막</shield>으로 전환합니다. 스킬을 <recast>재사용</recast>하면 <healing>남은 보호막의 {p3}%만큼 체력을 회복</healing>합니다.<br><br>최소 보호막 흡수량: <shield>{p4}</shield><br>최대 보호막 흡수량: <shield>{p5}</shield>", // 불멸
    ...
    "DrMundo": { // 문도 박사
        ...
        "W": "문도 박사가 제세동기를 충전하여 주변 적에게 최대 {p1}초까지 초당 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다. 추가로 첫 {p3}초 동안에는 입는 피해의 {p4}를, 남은 지속시간에는 입는 피해의 {p5}%를 회색 체력으로 저장하고 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 제세동기가 폭발하여 주변 적에게 <magicdamage>{p6}의 마법 피해</magicdamage>를 입힙니다. 챔피언에게 적중하면 문도 박사가 <healing>회색 체력의 {p7}%</healing>를 회복하며 그렇지 않으면 <healing>회색 체력의 {p8}%</healing>를 회복합니다.", // 심장 전기 충격
    ...
    "MissFortune": { // 미스 포츈
        "P": "미스 포츈이 새로운 대상에게 기본 공격을 가하면 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 추가로 입힙니다. <br><br><spellname>사랑의 한 방</spellname> 효과 발동 시 <spellname>활보</spellname> 스킬의 재사용 대기시간이 @Spell.MissFortuneViciousStrikes:LoveTapRefund@초 감소합니다.", // 사랑의 한 방 — stringtable
    ...
    "Milio": { // 밀리오
        ...
        "W": "밀리오가 {p1}초 동안 아군 챔피언을 따라가는 온기를 생성합니다. 지속시간 동안 근처 아군 챔피언의 공격 사거리가 {p2} 증가하고 <healing>{p3}의 체력</healing>을 회복합니다. 또한, 온기는 {p4}초마다 <spellname>타오르는 힘</spellname> 효과를 적용합니다.<br><br><recast>재사용 시:</recast> 온기가 따라가는 아군을 변경합니다.", // 아늑한 모닥불
    ...
    "Bard": { // 바드
        ...
        "W": "바드가 체력 회복 성소를 생성해, 처음 들어온 아군에게 {p1}초에 걸쳐 사라지는 <speed>{p2}의 이동 속도</speed>를 부여하고 최소 <healing>{p3}의 체력</healing>을 회복시킵니다. 성소의 체력 회복 효과는 점차 증가해, {p4}초 이후에는 최대 <healing>{p5}의 체력</healing>을 회복시킬 수 있습니다.<br><br>바드는 한 번에 최대 {p6}개의 성소를 세울 수 있습니다. 성소는 적 챔피언이 들어오면 파괴됩니다.<br><br>이 스킬은 {p7}회까지 충전됩니다.<br><br>현재 활성화된 성소: {p8} / {p9}", // 수호자의 성소
    ...
    "Vi": { // 바이
        ...
        "W": "<passive>기본 지속 효과:</passive> 같은 대상에게 기본 공격을 3번 가할 때마다 대상 <physicaldamage>최대 체력의 {p1}에 해당하는 물리 피해</physicaldamage>를 추가로 입히고 {p2}초간 대상의 <scalearmor>방어력을 {p3}%</scalearmor> 낮추며 바이의 <attackspeed>공격 속도가 {p4}%</attackspeed> 상승합니다. 또한 <spellname>폭발 보호막</spellname>의 재사용 대기시간이 @spell.ViPassive:CDReductionOn3Hit@초 감소합니다.", // 찌그러뜨리기
    ...
    "Veigar": { // 베이가
        ...
        "Q": "베이가가 암흑의 에너지 줄기를 쏟아내어 처음 맞는 두 명의 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.<br><br>베이가가 이 스킬로 적을 하나 처치할 때마다 <keywordmajor>극악</keywordmajor> 중첩이 @Spell.VeigarPassive:dQKillStacks@ 쌓입니다. 대형 미니언, 대형 몬스터의 경우 중첩이 @Spell.VeigarPassive:dQKillStacksLarge@만큼 추가로 쌓입니다.", // 사악한 일격
        "W": "베이가가 하늘에서 암흑 물질을 소환해 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.<br><br><keywordmajor>극악</keywordmajor>이 @Spell.VeigarPassive:PStacksPerDarkMatterCDR@번 중첩될 때마다 이 스킬의 재사용 대기시간이 @Spell.VeigarPassive:DarkMatterCDRIncrement*100@%씩 감소합니다.", // 암흑 물질
    ...
    "Vex": { // 벡스
        ...
        "Q": "벡스가 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히는 안개 파동을 발사합니다. 잠시 후 파동의 크기가 작아지고 속도는 빨라집니다.<br><br>적에게 적중하면 <keywordmajor>우울</keywordmajor>을 소모합니다.", // 안개 화살
        "W": "벡스가 {p1}초 동안 <shield>{p2}의 피해를 흡수하는 보호막</shield>을 얻고 <magicdamage>{p3}의 마법 피해</magicdamage>를 입히는 충격파를 방출합니다.<br><br>적에게 적중하면 <keywordmajor>우울</keywordmajor>을 소모합니다.", // 거리 두기
        "E": "벡스가 지정한 위치로 그림자가 날아가도록 명령합니다. 그림자는 날아가는 동안 크기가 커집니다. 도착 시 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다.<br><br>이 스킬로 적을 처치하면 <keywordmajor>파멸과 우울</keywordmajor>의 재사용 대기시간이 {p4}% 감소합니다.<br><br>적중한 적에게 <keywordmajor>우울</keywordmajor>을 적용합니다.", // 커지는 어둠
    ...
    "Briar": { // 브라이어
        ...
        "W": "브라이어가 도약해 <keywordmajor>핏빛 광분</keywordmajor> 상태에 들어가고 {p1}초간 가장 가까운 적에게 도발됩니다. (챔피언 우선) <keywordmajor>핏빛 광분</keywordmajor> 상태에서 <attackspeed>공격 속도가 {p2}%</attackspeed>, <speed>이동 속도가 {p3}%</speed> 상승하며 기본 공격으로 대상 주변 적에게 <physicaldamage>{p4}의 물리 피해</physicaldamage>를 입힙니다.<br><br>이 스킬을 <recast>재사용</recast>해 다음 기본 공격을 강화할 수 있습니다. 강화된 기본 공격으로 <physicaldamage>{p5}+잃은 체력의 {p6}%에 해당하는 물리 피해</physicaldamage>를 입히며, <healing>피해량의 {p7}+{p8}%만큼 체력을 회복</healing>합니다.<br>", // 핏빛 광분 / 식욕 폭발
    ...
    "Viktor": { // 빅토르
        ...
        "Q": "빅토르가 적에게 폭발을 일으켜 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히며 {p2}초 동안 <shield>{p3}의 피해를 흡수하는 보호막</shield>을 얻습니다.<br><br>4초 안에 기본 공격 시 <magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다.<br><br><keywordmajor>업그레이드 시:</keywordmajor> {p2}초 동안 <shield>{p5}의 피해를 흡수하는 보호막</shield>을 얻고 <speed>이동 속도가 {p6}%</speed> 증가합니다.", // 힘의 흡수
        "W": "빅토르가 중력장 감옥 장치를 배치해 {p1}초 동안 장치 내부의 적을 {p2}% <status>둔화</status>시킵니다. 범위 안에 1.25초 동안 있는 적은 {p3}초 동안 <status>기절</status>합니다.<br><br><keywordmajor>업그레이드한 기본 지속 효과:</keywordmajor> 빅토르의 스킬이 1초 동안 {p4}% <status>둔화</status>시킵니다.<br><br><br>", // 중력장
        "E": "빅토르가 선택한 방향으로 마법공학 광선을 발사하여 적중한 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.<br><br><keywordmajor>업그레이드 시:</keywordmajor> 마법공학 광선을 따라 여진이 일어나며 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다.<br><br><br>", // 마법공학 광선
        "R": "빅토르가 일정 지역에 {p1}초 동안 아케인 폭풍을 일으켜 즉시 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힌 후 주변 적에게 초당 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다. 폭풍은 최근 피해를 입힌 챔피언을 자동으로 따라갑니다.<br><br><recast>재사용 시:</recast> 빅토르가 직접 폭풍을 움직일 수 있습니다.<br><br><keywordmajor>업그레이드:</keywordmajor> 폭풍이 {p4}% 빠르게 이동합니다. 폭풍이 피해를 입힌 챔피언이 죽으면 폭풍의 크기가 커지고 지속시간이 {p5}초 증가합니다. (최대 {p6}회)<br><br>", // 아케인 폭풍
    },
    "Poppy": { // 뽀삐
    ...
    "Sion": { // 사이온
        "P": "사이온은 처치된 다음 되살아나 이동하고 공격할 수 있지만, 부활한 동안에는 체력이 급속히 떨어집니다. 생명력 흡수 효과가 {p1}% 증가하고 매우 빠르게 공격하며 적중 시 <physicaldamage>대상 최대 체력의 {p2}%에 해당하는 물리 피해</physicaldamage>를 추가로 입힙니다.<br><br>모든 스킬이 <spellname>죽음의 물결</spellname>로 대체되어 이동 속도가 대폭 상승합니다.", // 영광스러운 죽음 — stringtable
        ...
        "W": "<passive>기본 지속 효과</passive>: 사이온은 유닛을 하나 처치할 때마다 <scalehealth>최대 체력이 {p1}</scalehealth> 증가합니다. 챔피언 처치 관여, 대형 미니언 또는 대형 몬스터 처치 시 최대 체력이 <scalehealth>{p2}</scalehealth> 증가합니다.<br><br><active>사용 시</active>: 사이온이 6초간 <shield>{p3}의 피해를 흡수하는 보호막</shield>을 얻습니다. {p4}초 후에 보호막이 지속 중이라면 스킬을 <recast>재사용</recast>하여 보호막을 폭발시키고 <magicdamage>{p5}+대상 최대 체력의 {p6}%에 해당하는 마법 피해</magicdamage>를 입힙니다.", // 영혼의 용광로
        ...
        "R": "사이온이 8초 동안 저지 불가 상태가 되어 마우스 커서 방향으로 돌진합니다. 사이온이 적 챔피언이나 벽과 충돌하거나 스킬을 <recast>재사용</recast>하면 멈춥니다. <br><br>돌진이 끝나면 이동 거리에 비례해 <physicaldamage>{p1}~{p2}의 물리 피해</physicaldamage>를 입힙니다. 사이온 주변에 있는 적들은 이동 거리에 비례해 {p3}~{p4}초간 <status>기절</status>합니다. 더 넓은 범위에 있는 적들은 3초간 {p5}% <status>둔화</status>됩니다.", // 멈출 수 없는 맹공
    },
    "Sylas": { // 사일러스
    ...
    "Sett": { // 세트
        ...
        "W": "<passive>기본 지속 효과:</passive> 세트가 받은 피해량의 {p1}%를 최대 <keywordmajor>{p2}</keywordmajor>까지 <keywordmajor>투지</keywordmajor>로 저장합니다. <keywordmajor>투지</keywordmajor>는 피해를 입고 {p3}초 후에 빠르게 감소합니다.<br><br><active>사용 시:</active> 세트가 모든 <keywordmajor>투지</keywordmajor>를 소모해 <shield>소모한 투지의 {p4}%에 해당하는 보호막</shield>을 얻습니다. 보호막은 {p5}초에 걸쳐 사라집니다. 이후 세트가 강력한 펀치를 날려 중심에 있는 적에게 <truedamage>{p6}+소모한 투지의 {p7}에 해당하는 고정 피해</truedamage>를 입힙니다. (최대 <truedamage>{p8}의 피해</truedamage>) 중심에 있지 않은 적은 <physicaldamage>물리 피해</physicaldamage>를 입습니다.", // 강펀치
    ...
    "Sona": { // 소나
        "P": "<passive>아첼레란도</passive>: 소나가 기본 스킬을 잘 사용하면 아첼레란도 중첩을 얻습니다. 중첩당 기본 스킬 가속이 영구적으로 + {p1}씩, 최대 {p2}까지 증가합니다. 기본 스킬 가속이 {p2}에 도달하면 중첩을 추가로 얻는 대신 현재 <keywordmajor>궁극기</keywordmajor>의 재사용 대기시간이 @Spell.SonaPassive:AccelerandoUltCDR@초 감소합니다.<br><br><passive>파워 코드</passive>: 기본 스킬을 {p3}번 사용하고 나면 소나의 다음 기본 공격이 <magicdamage>{p4}의 마법 피해</magicdamage>를 추가로 입히며 마지막으로 연주한 곡의 추가 효과를 적용할 수 있습니다.<br><li><spellname>용맹의 찬가:</spellname> 대신 <magicdamage>@Spell.SonaQ:TotalStaccatoDamage@의 마법 피해</magicdamage>를 입힙니다.<li><spellname>인내의 아리아:</spellname> @Spell.SonaW:DiminuendoDuration@초 동안 대상이 주는 피해가 @Spell.SonaW:TotalDiminuendoWeakenPercent@만큼 감소합니다.<li><spellname>기민함의 노래:</spellname> @Spell.SonaE:TempoDuration@초 동안 대상이 @Spell.SonaE:TotalTempoMoveSpeedSlow@만큼 <status>둔화</status>됩니다.", // 파워 코드 — stringtable
    ...
    "Soraka": { // 소라카
        ...
        "W": "소라카가 다른 아군 챔피언의 <healing>체력을 {p1}</healing>만큼 회복시킵니다.<br><br>소라카가 <keywordmajor>별의 가호</keywordmajor>를 받고 있으면 체력 소모량이 {p2}% 감소하며 대상도 @Spell.SorakaQ:HoTDuration@초 동안 <keywordmajor>별의 가호</keywordmajor>를 받습니다.", // 은하의 마력
    ...
    "Smolder": { // 스몰더
        "P": "스킬로 챔피언을 맞히고 <spellname>초강력 화염 숨결</spellname> 스킬로 적을 처치하면 <spellname>용 훈련</spellname> 중첩을 1회 얻습니다. 중첩은 스몰더의 기본 스킬을 강화합니다.<br><li><spellname>초강력 화염 숨결</spellname>: <magicdamage>{p1}의 마법 피해</magicdamage>를 추가로 입히고 @spell.SmolderQ:StackTier1@회, @spell.SmolderQ:StackTier2@회, @spell.SmolderQ:StackTier3@회 중첩 시 새로운 효과를 얻습니다.<li><spellname>에취!</spellname>: 폭발이 <magicdamage>{p2}의 마법 피해</magicdamage>를 추가로 입힙니다.<li><spellname>펄럭펄럭</spellname>: 적중할 때마다 <magicdamage>{p3}의 마법 피해</magicdamage>를 추가로 입히고 중첩이 {p4}회 쌓일 때마다 추가 번개를 얻습니다.<br><br><rules>스몰더가 <font color='#c93c3c'>용 훈련</font> 중첩을 <font color='#c93c3c'>{p5}</font> 획득했습니다.</rules>", // 용 훈련 — stringtable
        "Q": "스몰더가 불꽃을 내뿜어 <physicaldamage>{p1}의 물리 피해</physicaldamage>+<magicdamage>@spell.SmolderP:Passive_QDamageIncrease@의 마법 피해</magicdamage>를 입힙니다. 대상이 사망하면 스몰더가 스킬 사용 한 번당 <scalemana>{p2}의 마나</scalemana>를 돌려받습니다.<br><br>이 스킬은 <spellname>용 훈련</spellname> 중첩 수에 따라 진화하며 다음과 같은 효과를 얻습니다.<li><keywordmajor>{p3}회 중첩</keywordmajor>: 대상 주변의 모든 적에게 피해를 입힙니다.<li><keywordmajor>{p4}회 중첩</keywordmajor>: 이 스킬 피해량의 {p5}%만큼 피해를 입히는 폭발 <spellname>{p6}</spellname>개를 대상 너머로 날립니다.<li><keywordmajor>{p7}회 중첩</keywordmajor>: 대상을 불태우며 {p8}초에 걸쳐 <truedamage>최대 체력의 {p9}에 해당하는 고정 피해</truedamage>를 입힙니다. 불타는 동안 총 체력이 <truedamage>{p10}</truedamage> 밑으로 떨어지는 적 챔피언은 즉시 처치됩니다.", // 초강력 화염 숨결
        "W": "스몰더가 앙증맞은 불꽃 재채기를 내뿜어 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다.<br><br>챔피언에게 적중하면 폭발이 일어나며 <physicaldamage>{p4}의 물리 피해</physicaldamage>+<magicdamage>@spell.SmolderP:Passive_WDamageIncrease@의 마법 피해</magicdamage>를 입힙니다.", // 에취!
        "E": "스몰더가 하늘을 날며 {p1}초 동안 <speed>이동 속도가 {p2}%</speed> 증가하고 지형을 무시합니다.<br><br>스몰더는 비행하는 동안 체력이 가장 낮은 적을 <spellname>{p3}</spellname>(내림 적용)회 폭격해 공격 적중 시 <physicaldamage>{p4}의 물리 피해</physicaldamage>+<magicdamage>@spell.SmolderP:EBonusDamage@의 마법 피해</magicdamage>를 입힙니다.", // 펄럭펄럭
    ...
    "Swain": { // 스웨인
        "P": "스웨인이 <spellname>제국의 눈</spellname>, <spellname>속박명령</spellname>, 적 챔피언 사망을 통해 <font color='#FF3F3F' size='18'>영혼 조각</font>을 획득합니다. <font color='#FF3F3F' size='18'>영혼 조각</font>을 모으면 <healing>최대 체력의 {p1}</healing>를 회복하고 영구적으로 스웨인의 <healing>최대 체력이 {p2}</healing> 증가합니다.<br><br>수집한 영혼 조각: {p3}<br>총 체력 획득량: <scalehealth>{p4}</scalehealth>", // 굶주린 새떼 — stringtable
        ...
        "E": "스웨인이 악마의 파동을 발사합니다. 파동은 돌아오며 처음으로 적에게 부딪히는 순간 폭발해 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 대상 지역에 있는 적을 {p2}초 동안 <status>속박</status>합니다.<br><br>챔피언을 <status>속박</status>하면 이 스킬을 다시 사용해 <spellname>속박명령</spellname>으로 <status>속박</status>된 모든 챔피언을 끌어당겨 챔피언 하나당 <font color='#FF3F3F' size='18'>영혼 조각</font> 하나를 획득할 수 있습니다.", // 속박명령
        "R": "스웨인이 악을 끌어내 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 매초 주변 적의 <healing>체력을 {p2}</healing> 흡수합니다. 악마의 기운은 시간이 지나면서 소진되지만 적 챔피언을 흡수해 무한히 충전할 수 있으며 챔피언 처치 관여 시 완전히 충전됩니다.<br><br>{p3}초 후 그리고 {p4}초가 지날 때마다 스웨인이 변신 상태에서 <spellname>악의 불길</spellname>을 사용해 적에게 <magicdamage>{p5}의 마법 피해</magicdamage>를 입히고 {p6}% <status>둔화</status>시킬 수 있습니다. 둔화 효과는 {p7}초에 걸쳐 사라집니다.", // 악의 승천
    },
    "Skarner": { // 스카너
        ...
        "Q": "스카너가 땅에서 바위를 뜯어내 다음 기본 공격 3회의 <attackspeed>공격 속도를 {p1}%</attackspeed> 강화하고 주변 적에게 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다. 마지막 기본 공격은 <physicaldamage>최대 체력의 {p3}%에 해당하는 물리 피해</physicaldamage>를 추가로 입히고 영향을 받은 적을 {p4}초 동안 {p5}% <status>둔화</status>시킵니다.<br><br><recast>재사용 시:</recast> 스카너가 이 스킬을 끝내고 바위를 던져 <physicaldamage>@spell.SkarnerQ:AbilityDamage@+최대 체력의 @spell.SkarnerQ:MaxHPPercent*100@%에 해당하는 물리 피해</physicaldamage>를 입히고 추가로 처음 적중한 적과 그 주변에 있는 적을 @spell.SkarnerQ:SlowDuration@초 동안 @spell.SkarnerQ:SlowPercent*100@% <status>둔화</status>시킵니다.", // 부서진 대지/지반 돌출
    ...
    "Thresh": { // 쓰레쉬
        ...
        "Q": "쓰레쉬가 낫을 던져 첫 번째로 맞힌 대상을 <status>기절</status>시키고 {p1}초간 자신 쪽으로 <status>당겨</status> 옵니다. 대상에게 <magicdamage>{p2}의 마법 피해</magicdamage>를 입히고 지속시간 동안 <keywordstealth>절대 시야</keywordstealth>를 얻습니다.<br><br>이 스킬을 <recast>재사용</recast>하면 쓰레쉬가 잡힌 적 쪽으로 끌려갑니다.<br><br>이 스킬로 적을 맞히면 재사용 대기시간이 {p3}초 감소합니다.", // 사형 선고
    ...
    "AurelionSol": { // 아우렐리온 솔
        "P": "아우렐리온 솔이 스킬로 피해를 입히면 스킬을 강화하는 <font color='#3458eb'>별가루</font>를 획득합니다.<li><spellname>빛의 숨결</spellname>: 폭발 시 <magicdamage>최대 체력의 {p1}에 해당하는 마법 피해</magicdamage>를 추가로 입힙니다.</li><li><spellname>별의 비행</spellname>: 거리가 {p2}% 증가합니다.</li><li><spellname>특이점</spellname>: 범위가 {p3}% 증가하고 처형 기준값이 <scalehealth>{p4}</scalehealth> 증가됩니다.</li><li><spellname>유성 및 천상 강림</spellname>: 범위가 {p5}% 증가합니다.</li><br><rules>아우렐리온 솔이 획득한 <font color='#3458eb'>별가루</font>: <font color='#3458eb'>{p6}</font></rules>", // 우주의 창조자 — stringtable
        ...
        "W": "아우렐리온 솔이 한 방향으로 날아갑니다. 비행 중에는 <spellname>빛의 숨결</spellname>의 재사용 대기시간과 최대 정신 집중 시간이 없으며 기본 피해량이 {p1}% 증가합니다.<br><br>챔피언에게 피해를 입힌 후 {p2}초 안에 처치에 관여하면 이 스킬의 재사용 대기시간을 {p3}%만큼 돌려받습니다.<br><br><recast>재사용 시:</recast> 비행을 일찍 종료합니다.", // 별의 비행
        ...
        "R": "아우렐리온 솔이 하늘에서 별을 뽑아 땅으로 떨어뜨려 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고, 적을 {p2}초 동안 <status>기절</status>시키고, 적중한 챔피언 하나당 <font color='#3458eb'>별가루 {p3}개</font>를 흡수합니다.<br><br><font color='#3458eb'>별가루 {p4}개</font>를 모으면 다음 <spellname>유성</spellname>을 <spellname>천상 강림</spellname>으로 바꿉니다.<br><br><spellname>천상 강림</spellname>: 아우렐리온 솔이 우주에서 별자리 하나만큼의 분노를 내려 넓은 범위에 있는 적에게 <magicdamage>{p5}의 마법 피해</magicdamage>를 입히고, 적중한 적을 {p2}초 동안 <status>공중으로 띄워 올립니다</status>. 또한, 거대한 충격파를 퍼뜨려 챔피언과 에픽 몬스터에게 <magicdamage>{p6}의 마법 피해</magicdamage>를 입히고 적중한 모든 적을 1초 동안 {p7}% <status>둔화</status>시킵니다.", // 유성 / 천상 강림
    },
    "Ivern": { // 아이번
        ...
        "R": "아이번이 파수꾼 친구 데이지를 소환해 {p1}초 동안 함께 전투합니다.<br><br><active>데이지, 후려쳐!:</active> 데이지가 같은 챔피언이나 에픽 몬스터를 연속으로 세 번 공격하면 충격파를 일으켜 적중한 모든 적에게 <magicdamage>{p2}의 마법 피해</magicdamage>를 입히고 {p3}초 동안 <status>공중으로 띄워 올립니다</status>. 이 효과는 {p4}초에 한 번씩만 발생할 수 있습니다.<br><br><recast>재사용 시:</recast> 데이지에게 공격 또는 이동을 지시합니다.", // 데이지!
    },
    "Azir": { // 아지르
    ...
    "Akali": { // 아칼리
        ...
        "E": "아칼리가 뒤로 공중제비를 돌며 표창을 던져 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 표창에 맞은 첫 번째 적이나 연막에 표식을 남깁니다. 한 번 더 <recast>재사용</recast>하면 표식을 남긴 대상에게 돌진해 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다.", // 표창곡예
        "R": "아칼리가 적 챔피언을 뛰어넘어 경로 내에 있는 모든 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다. <br><br>{p2}초 후 <recast>재사용</recast>하면 적들을 관통하며 돌진하여 대상이 잃은 체력에 비례해 <magicdamage>{p3}</magicdamage>~<magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다.", // 무결처형
    },
    "Akshan": { // 아크샨
        ...
        "E": "<active>첫 사용 시:</active> 아크샨이 적중한 첫 번째 지형에 고정되는 갈고리총을 발사합니다.<br><br><active>두 번째 사용 시:</active> 아크샨이 갈고리에 매달려 이동하며 가장 가까운 적에게 연속으로 탄환을 발사해 한 발당 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다.<br><br><active>세 번째 사용 시:</active> 아크샨이 밧줄을 놓고 뛰어내리며 마지막 탄환을 발사합니다.<br><br>적 챔피언이나 지형에 부딪히면 영웅의 비상이 일찍 끝납니다.<br><br>챔피언 처치 관여 시 이 스킬의 재사용 대기시간이 초기화됩니다.", // 영웅의 비상
    ...
    "Aphelios": { // 아펠리오스
        "P": "아펠리오스는 쌍둥이 누이 알룬이 만든 다섯 가지의 루나리 무기를 사용합니다. 한 번에 주 무기와 보조 무기 등 총 두 가지 무기를 사용할 수 있습니다. 각 무기는 고유의 기본 공격 및 [@spell.ApheliosCalibrumQ:Hotkey@] 스킬을 가지고 있습니다. 기본 공격과 스킬 사용 시 탄약을 소모하며, 탄약을 모두 소모하면 사용 중인 주 무기를 다음 무기로 교체합니다. <br><br>2레벨 도달 시 [@spell.ApheliosCalibrumQ:Hotkey@] 스킬을 사용할 수 있으며 6레벨 도달 시 궁극기를 사용할 수 있습니다. 아펠리오스는 스킬 포인트로 스킬 레벨을 올리는 대신 영구 능력치를 획득합니다.<br><br><passive>루나리 무기 순서:</passive><li>{{ Spell_ApheliosP_GunShortDesc_{p1} }}</li><li>{{ Spell_ApheliosP_GunShortDesc_{p2} }}</li><font color='#424242'><li>{{ Spell_ApheliosP_GunShortDesc_{p3} }}</li><li>{{ Spell_ApheliosP_GunShortDesc_{p4} }}</li><li>{{ Spell_ApheliosP_GunShortDesc_{p5} }}</li></font>", // 암살자와 예언자 — stringtable
        "Q": "", // 무기 스킬
        "W": "주 무기와 보조 무기를 교체하여 <b><i><font color='#a64dff'>중력포</font></i></b>을 장착합니다.", // 위상 변화
        "E": "", // 무기 교체 시스템
        "R": "챔피언에게 적중 시 폭발하는 달빛 에너지를 발사하여 주변 적에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다.<br><br>이후 적중한 모든 챔피언을 주 무기로 공격합니다. {{ Spell_ApheliosR_WeaponMod_{p2} }}", // 월광포화
    },
    "Alistar": { // 알리스타
    ...
    "Ambessa": { // 암베사
        ...
        "Q": "<active>교활한 휩쓸기</active>: 암베사가 칼날로 전방을 휩쓸어 공격 범위 가장자리에 있는 적에게 <physicaldamage>{p1}+최대 체력의 {p2}에 해당하는 물리 피해</physicaldamage>를 입힙니다. 다른 모든 적에게는 {p3}의 피해를 입힙니다. 적에게 공격이 적중하면 <active>파멸의 일격</active>을 준비합니다.<br><br><active>파멸의 일격</active>: 암베사가 칼날로 내려찍어 처음 적중하는 적에게 <physicaldamage>{p4}+최대 체력의 {p5}에 해당하는 물리 피해</physicaldamage>를 입힙니다. 다른 모든 적에게는 {p6}의 피해를 입힙니다.", // 교활한 휩쓸기 / 파멸의 일격
    ...
    "Anivia": { // 애니비아
        ...
        "Q": "애니비아가 거대한 얼음 덩어리를 발사해 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 적들을 {p2}초 동안 <keywordmajor>냉각</keywordmajor>하여 @Spell.GlacialStorm:SlowAmount@% <status>둔화</status>시킵니다. 사거리 끝에 다다르면 얼음이 폭발하며 적들을 {p3}초 동안 <status>기절</status>시키고 <magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다.<br><br>애니비아가 스킬을 <recast>재사용</recast>하면 얼음 덩어리가 일찍 폭발합니다.", // 냉기 폭발
    ...
    "Ashe": { // 애쉬
        ...
        "Q": "<passive>기본 지속 효과: </passive>애쉬가 기본 공격 시 {p1}초 동안 유지되는 중첩이 1회 쌓입니다. {p2}회 중첩 시 이 스킬을 사용할 수 있습니다.<br><br><passive>사용 시:</passive> {p3}초 동안 애쉬의 <attackspeed>공격 속도가 {p4}%</attackspeed> 오르며 기본 공격이 <physicaldamage>{p5}의 피해</physicaldamage>를 입힙니다.", // 궁사의 집중
    ...
    "Elise": { // 엘리스
        "P": "엘리스는 궁극기를 가지고 게임을 시작하여 <keywordmajor>인간 형태</keywordmajor>와 <keywordmajor>거미 형태</keywordmajor>로 변신할 수 있습니다.<br><br><keywordmajor>인간 형태:</keywordmajor> 엘리스의 스킬이 적에게 적중하면 휴면 상태의 <keywordmajor>새끼 거미</keywordmajor>를 얻습니다. (최대 @spell.EliseR:BaseSpiderlingsStored@)<br><br><keywordmajor>거미 형태:</keywordmajor> 기본 공격 시 추가로 <magicdamage>@spell.EliseR:PassiveTotalDamage@의 마법 피해</magicdamage>를 입히고, <healing>@spell.EliseR:PassiveTotalHealing@의 체력</healing>을 회복합니다.", // 거미 여왕 — stringtable
    ...
    "MonkeyKing": { // 오공
        ...
        "R": "오공이 <speed>{p1}%의 이동 속도</speed>를 얻고 {p2}초 동안 여의봉을 휘두릅니다. 여의봉에 맞은 근처 적들은 {p3}초 동안 <status>공중에</status> 뜨며 <physicaldamage>{p4}+최대 체력의 {p5}에 해당하는 물리 피해</physicaldamage>를 입습니다.<br><br>재사용 대기시간이 적용되기 전 {p6}초 안에 이 스킬을 한 번 더 사용할 수 있습니다.", // 회전격
    },
    "Aurora": { // 오로라
    ...
    "Ornn": { // 오른
        "P": "{{Spell_OrnnP_Tooltip_{p1}}}", // 간이 대장간 — stringtable
        ...
        "R": "오른이 자신에게 다가오는 거대한 불의 정령을 소환해 적들에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 <keywordmajor>불안정</keywordmajor> 상태로 만들며 {p3}% <status>둔화</status>시킵니다.<br><br>오른이 스킬을 <recast>재사용</recast>하면 돌진하며 박치기합니다. 정령에게 박치기를 하면 정령의 진행 방향을 바꾸고 힘을 실어 줄 수 있습니다. 힘을 받은 정령은 처음 닿는 적 챔피언을 {p4}초 동안, 나머지 적 챔피언들은 {p5}초 동안 <status>공중으로 띄워 올립니다</status>. 또한 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 다시 한번 <keywordmajor>불안정</keywordmajor> 상태로 만듭니다.", // 대장장이 신의 부름
    },
    "Orianna": { // 오리아나
    ...
    "Yone": { // 요네
        ...
        "Q": "전방으로 검을 내질러 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다.<br><br>적중 시, {p2}초간 1회 중첩됩니다. 2회 중첩되면 요네가 전방으로 돌진하며 돌풍을 날려 {p3}초 동안 적을 <status>공중으로 띄워 올리고</status> <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다.", // 필멸의 검
        ...
        "E": "요네가 {p1}초 동안 영혼 상태가 되어 육신을 떠나고 <speed>이동 속도가 {p2}%</speed>에서 <speed>{p3}%</speed>까지 점차 증가합니다. <br><br>영혼 상태가 끝나면 다시 육신으로 돌아오며 영혼 상태에서 챔피언에게 입힌 모든 기본 공격 및 스킬 피해량의 {p4}%를 다시 입힙니다. 영혼 상태에서 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시: </recast>영혼 상태를 더 일찍 종료합니다.", // 영혼해방
    ...
    "Yorick": { // 요릭
        ...
        "Q": "요릭이 다음 기본 공격으로 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 추가로 입히고 <healing>{p2}+요릭이 잃은 체력의 {p3}%</healing>를 회복합니다. 챔피언이 아닌 대상 상대 시 회복량이 {p4}% 감소합니다. 이 공격으로 챔피언 또는 대형 몬스터를 타격하거나 대상을 처치하면 무덤이 생성됩니다.<br><br>근처에 무덤이 3개 이상 있을 때 이 스킬을 이미 사용한 상태라면 <recast>재사용</recast>하여 근처의 모든 무덤에서 <keywordmajor>안개 망령</keywordmajor>을 일으킬 수 있습니다.", // 최후의 의식
        "W": "요릭이 영혼의 벽을 소환하여 적의 길을 막되 아군의 길은 막지 않습니다. 영혼의 벽은 <healing>{p1}의 체력</healing>을 가지며 {p2}초 후 사라집니다.", // 망자의 진
        "E": "요릭이 안개의 구를 던져 <magicdamage>최대 체력의 {p1}만큼 마법 피해</magicdamage>를 입히고 {p2}초 동안 {p3} <status>둔화</status>시키며, {p4}초 동안 챔피언과 몬스터에게 표식을 남깁니다. 표식이 남은 적은 무덤 근처에서 지속적으로 안개 망령을 <spellname>각성</spellname>시킵니다. (최대 @Spell.YorickPassive:YorickPassiveGhoulMax@명까지 소환됩니다.) 또한 <scalearmor>방어력이 {p5}% 감소</scalearmor>합니다.<br><br>요릭과 요릭이 소환한 유닛은 표식이 있는 대상 쪽으로 이동할 때 <speed>이동 속도가 {p6}%</speed> 증가합니다. <keywordmajor>안개 망령</keywordmajor>은 멀어지는 적에게 한 번 뛰어들 수 있습니다.", // 애도의 안개
    ...
    "Urgot": { // 우르곳
        ...
        "W": "<passive>기본 지속 효과:</passive> 우르곳의 다른 스킬이 마지막으로 적중한 챔피언에게 5초 동안 표식을 남깁니다.<br><br><active>사용 시:</active> 우르곳이 표식이 남은 적을 우선으로 가장 가까운 적에게 기관총을 발사합니다. 초당 {p1}회 공격하여 사격 1회당 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다. 우르곳은 사격 시 이동할 수 있으며 <status>둔화</status> 저항이 {p3}% 증가하지만 <speed>이동 속도가 {p4}</speed> 감소합니다.<br><br>스킬 레벨을 끝까지 올리면 스킬이 무한히 지속되며 활성화 상태를 <toggle>전환</toggle>할 수 있습니다.", // 심판의 원
        ...
        "R": "우르곳이 마공학 송곳 섬광탄을 발사하여 섬광탄이 처음 적중한 챔피언에게 꽂힙니다. 섬광탄은 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히며, {p2}초 동안 잃은 체력 1%당 1%씩 최대 {p3}% <status>둔화</status>시킵니다.<br><br>대상의 체력이 {p4}% 이하로 떨어지면 우르곳이 스킬을 <recast>재사용</recast>하여 대상을 <status>제압</status>하고 자신에게 끌어당깁니다. 우르곳 앞에 도착한 대상은 처치되며 주변 적은 {p5}초 동안 <status>공포</status>에 빠집니다.", // 불사의 공포
    },
    "Warwick": { // 워윅
        ...
        "E": "{p1}초 동안 워윅이 입는 피해가 {p2}% 감소합니다. 지속시간이 종료되면 워윅이 포효하며 근처의 모든 적을 {p3}초 동안 <status>공포</status>에 빠뜨립니다. <recast>재사용</recast>하면 스킬이 일찍 종료됩니다.", // 원시의 포효
    ...
    "Yunara": { // 유나라
        ...
        "Q": "<passive>기본 지속 효과:</passive> 유나라가 <onhit>적중 시</onhit> <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 기본 공격이 <evolve>방출을 {p2}</evolve>(챔피언일 경우 <evolve>방출 {p3}</evolve>) 생성합니다.<br><br><passive>사용 시:</passive> 유나라가 <evolve>방출을 {p4}</evolve> 소모하여 {p5}초 동안 <attackspeed>공격 속도를 {p6}</attackspeed> 얻고 <onhit>적중 시</onhit> <magicdamage>{p7}의 마법 피해</magicdamage>를 추가로 입힙니다. 지속시간 동안 유나라의 기본 공격이 주변 적에게 확산되어 <physicaldamage>{p8}의 물리 피해</physicaldamage>를 입힙니다.<br><br><keywordmajor>초월 상태</keywordmajor>: 이 스킬이 즉시 활성화되어 @Spell.YunaraR:Buff_Duration@초 동안 지속됩니다.", // 영혼 단련
    ...
    "Yuumi": { // 유미
        ...
        "Q": "유미가 상황에 따라 방향을 바꿀 수 있는 미사일을 소환하여 처음 적중한 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}% <status>둔화</status>시킵니다.<br><br><keywordmajor>밀착 상태</keywordmajor>에서 사용하면 유미가 마우스로 미사일을 조종할 수 있습니다. 일단 속도가 붙은 미사일은 조종할 수 없고 직선으로 날아가며 대상에게 <magicdamage>{p3}의 마법 피해</magicdamage>를 입히고 {p4}초 동안 {p5}% <status>둔화</status>시킵니다.<br><br><keywordmajor>단짝 추가 효과:</keywordmajor> <spellname>사르르탄</spellname>의 <status>둔화</status> 효과가 항상 강화되며 적 챔피언에게 둔화 적용 시 {p6}초 동안 단짝이 강화되어 <onhit>적중 시 </onhit> <magicdamage>{p7}의 마법 피해</magicdamage>를 추가로 입힙니다.<br><br><rules>적중 시 추가 피해량은 단짝의 치명타 확률에 따라 {p8}% 증가할 수 있습니다.</rules>", // 사르르탄
        "W": "<passive>기본 지속 효과:</passive> <keywordmajor>단짝</keywordmajor>에게 붙어있을 때 유미의 <keywordmajor>체력 회복 및 보호막 효과가 {p1}%</keywordmajor> 추가로 증가하며, 단짝은 <healing>체력을 {p2}</healing> 회복합니다. <onhit>적중 시 </onhit>.<br><br><active>사용 시:</active> 유미가 아군 챔피언에게 돌진하여 <keywordmajor>밀착</keywordmajor>합니다. 유미는 <keywordmajor>밀착 상태</keywordmajor>에서 밀착 대상을 따라다니며 포탑을 제외한 유닛이 대상으로 지정할 수 없는 상태가 됩니다.<br><br>유미에게 <status>이동 불가</status> 효과가 적용되면 이 스킬에 {p3}초의 재사용 대기시간이 적용됩니다.", // 너랑 유미랑!
    ...
    "Irelia": { // 이렐리아
        ...
        "E": "이렐리아가 지면에 검을 던집니다. {p1}초 내에 스킬을 <recast>재사용</recast>할 수 있습니다. <br><br><recast>재사용 시:</recast> 이렐리아가 두 번째 검을 던진 후 두 검이 서로를 향해 날아들어 {p2}초 동안 적을 <status>기절</status>시키고 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다. 챔피언과 대형 정글 몬스터는 {p4}초 동안 <keywordmajor>불안정</keywordmajor> 상태가 됩니다.", // 쌍검협무
    ...
    "Evelynn": { // 이블린
        ...
        "Q": "이블린이 가시를 발사해 처음 적중한 유닛에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다. 그 후 동일 대상에게 가하는 이블린의 다음 세 번의 기본 공격 또는 스킬이 <magicdamage>{p2}의 마법 피해</magicdamage>를 추가로 입힙니다. 이블린이 증오의 가시를 최대 {p3}번까지 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 이블린이 발사한 가시가 가장 가까운 적을 통과하고 적중한 모든 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.", // 증오의 가시
        ...
        "E": "이블린이 채찍으로 적을 가격하여 <magicdamage>{p1}+대상 최대 체력의 {p2}에 해당하는 마법 피해</magicdamage>를 입힙니다. 이후 이블린이 {p3}초 동안 <speed>{p4}%의 이동 속도</speed>를 얻습니다.<br><br><keywordmajor>악의 장막</keywordmajor>이 활성화되면 이 스킬의 재사용 대기시간이 초기화되고 강화됩니다. 강화된 스킬을 사용하면 이블린이 대상에게 돌진하며, 대상 및 경로에 있는 모든 적에게 <magicdamage>{p5}+대상 최대 체력의 {p6}에 해당하는 마법 피해</magicdamage>를 입힙니다.", // 채찍유린
    ...
    "Illaoi": { // 일라오이
        ...
        "R": "일라오이가 성상을 바닥에 내리쳐 근처 적들에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히고, 피해를 입는 적 챔피언 한 명당 촉수를 하나씩 소환합니다.<br><br>이후 촉수는 {p2}초 동안 <keywordmajor>후려치기</keywordmajor>의 사용 속도가 50% 빨라지고 대상으로 지정할 수 없게 됩니다. <spellname>혹독한 가르침</spellname>의 재사용 대기시간이 @spell.IllaoiW:CooldownDuringR@초로 줄어듭니다.", // 믿음의 도약
    },
    "JarvanIV": { // 자르반 4세
    ...
    "Zyra": { // 자이라
        "P": "자이라가 주변에 30초간 유지되는 <keywordmajor>씨앗</keywordmajor>을 {p1}초마다 생성합니다. <keywordmajor>씨앗</keywordmajor>은 한 번에 8개까지 심을 수 있습니다. 적 챔피언이 밟은 <keywordmajor>씨앗</keywordmajor>은 죽습니다. 자이라가 수풀에 숨은 동안에는 <keywordmajor>씨앗</keywordmajor>이 생성되지 않습니다.<br><br><keywordmajor>씨앗</keywordmajor>은 자이라의 다른 스킬로 사용되어 <magicdamage>{p2}의 마법 피해</magicdamage>를 입히는 식물을 생성합니다.", // 가시 정원 — stringtable
        "Q": "자이라가 굵은 가시덤불이 지면을 뚫고 나와 폭발하게 하여 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.<br><br><keywordmajor>씨앗</keywordmajor> 근처에서 이 스킬을 사용하면 <keywordmajor>씨앗</keywordmajor>이 가시 발사 꽃으로 자라 <magicdamage>@spell.ZyraP:PlantDamage@의 마법 피해</magicdamage>를 입히고 @spell.ZyraP:PlantDuration@초 동안 유지됩니다. 가시 발사 꽃의 사거리는 575입니다.", // 치명적인 가시
    ...
    "Zaahen": { // 자헨
        ...
        "Q": "자헨이 다음 기본 공격 시 두 번 공격하며 <physicaldamage>{p1}의 추가 물리 피해</physicaldamage>를 입히고 <healing>최대 체력의 {p2}%</healing>만큼 체력을 회복합니다.<br><br><recast>재사용 시:</recast> 다음 기본 공격 시 대상에게 <physicaldamage>{p3}의 추가 물리 피해</physicaldamage>를 입히고 {p4}초 동안 <status>공중에 띄웁니다</status>.", // 다르킨의 글레이브
    ...
    "Janna": { // 잔나
        ...
        "W": "<passive>기본 지속 효과:</passive> 잔나의 <speed>이동 속도가 {p1}</speed> 증가하며 유체화 상태가 됩니다.<br><br><active>사용 시:</active> 잔나의 원소가 적을 공격하여 {p2}초 동안 {p3} <status>둔화</status>시키고 <magicdamage>{p4}+@spell.TailwindSelf:BonusDamage@의 마법 피해</magicdamage>를 입힙니다.", // 서풍
    ...
    "Zed": { // 제드
        ...
        "W": "<passive>기본 지속 효과:</passive> 제드와 <keywordmajor>그림자</keywordmajor>가 같은 스킬로 동일한 대상을 공격할 때마다 제드가 <keywordmajor>{p1}의 기력</keywordmajor>을 얻습니다.<br><br><active>사용 시:</active> 제드의 <keywordmajor>그림자</keywordmajor>가 전방으로 질주하여, {p2}초간 그 자리에 유지됩니다. 이 스킬을 <recast>재사용</recast>하면 제드가 <keywordmajor>그림자</keywordmajor>와 위치를 바꿉니다.", // 살아있는 그림자
        ...
        "R": "제드가 잠시 대상으로 지정할 수 없는 상태가 되어 적 챔피언에게 돌진하며 표식을 남깁니다. {p1}초가 지나면 표식이 발동되며 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입히고 표식이 적용된 동안 제드가 대상에게 가한 피해의 {p3}%에 해당하는 피해를 추가로 입힙니다.<br><br>돌진 시 {p4}초 동안 유지되는 <keywordmajor>그림자</keywordmajor>가 남습니다. 이 스킬을 <recast>재사용</recast>하면 제드가 이 <keywordmajor>그림자</keywordmajor>와 위치를 바꿉니다.", // 죽음의 표식
    },
    "Xerath": { // 제라스
    ...
    "Zeri": { // 제리
        "P": "제리의 기본 공격은 스킬로 간주되며, 이동하거나 <spellname>집중 사격</spellname>을 사용해 충전할 수 있습니다. 충전되지 않은 기본 공격은 충전된 에너지의 일부를 소모하며 <magicdamage>@Spell.ZeriQ:MinDamage@의 마법 피해</magicdamage>를 입히고 <attention>체력 @Spell.ZeriQ:PassiveExecuteThreshold@</attention> 아래의 적을 <danger>처형</danger> 합니다. 완전히 충전된 기본 공격은 <magicdamage>@Spell.ZeriQ:PassiveMaxDamage@+최대 체력의 @Spell.ZeriQ:PassiveMaxChargePercentHealth@에 해당하는 마법 피해</magicdamage>를 입히고 충전된 에너지를 전부 소모합니다.", // 살아있는 배터리 — stringtable
    ...
    "Zoe": { // 조이
        ...
        "Q": "조이가 이동거리가 길어질수록 더 큰 피해를 입히는 별을 발사합니다. 처음 적중한 적과 주변 적은 <magicdamage>{p1}~{p2}의 마법 피해</magicdamage>를 입습니다.<br><br>조이는 스킬을 <recast>재사용</recast>해 별을 근처의 새로운 목표 지점으로 보낼 수 있습니다.", // 통통별
    ...
    "Zilean": { // 질리언
        "P": "{{Spell_HeightenedLearning_Tooltip_{p1}}}", // 시간의 유리병 — stringtable
    ...
    "Jinx": { // 징크스
        ...
        "Q": "징크스가 생선대가리 로켓 런처와 빵야빵야 미니건을 변환합니다.<br><br>로켓 런처로 기본 공격 시 마나를 소모하여 대상과 주변 적들에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다. 추가 공격 속도는 {p2}% 느려지지만 사거리는 {p3}만큼 증가합니다.<br><br>미니건으로 기본 공격 시 {p4}초 동안 <attackspeed>공격 속도</attackspeed>가 상승합니다. 이 효과는 최대 {p5}번까지 중첩됩니다. (<attackspeed>최대 의 {p6}%</attackspeed>)", // 휘릭휘릭!
    ...
    "Karma": { // 카르마
        ...
        "R": "카르마가 8초 동안 다음 스킬을 강화합니다.<br><li><spellname>내면의 열정</spellname>: <magicdamage>{p1}의 마법 피해</magicdamage>를 추가로 입히고 원형의 불꽃을 남깁니다. 불꽃은 적들을 <status>둔화</status>시키고 <magicdamage>{p2}의 마법 피해</magicdamage>를 추가로 입힙니다.<li><spellname>굳은 결의</spellname>: 카르마가 지속시간 처음과 끝에 <healing>{p3}의 잃은 체력</healing>을 회복하고, {p4}초 더 <status>속박</status>합니다.<li><spellname>고무</spellname>: 카르마가 대상에게 <shield>피해를 {p5}만큼 더 흡수하는 보호막</shield>을 씌웁니다. 주변 아군에게도 <shield>{p6}의 피해를 흡수하는 보호막</shield>을 씌우고 <speed>이동 속도를{p7}%</speed> 상승시킵니다.", // 만트라
    },
    "Camille": { // 카밀
        ...
        "Q": "카밀이 다음 기본 공격 시 <physicaldamage>{p1}의 추가 물리 피해</physicaldamage>를 입히고 {p2}초 동안 <speed>이동 속도가 {p3}%</speed> 증가합니다. {p4}초 후에 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br>첫 번째 기본 공격 후 {p5}초가 지난 뒤 스킬을 <recast>재사용</recast>하여 공격 시 추가 피해량이 증가해 <physicaldamage>{p6}</physicaldamage>의 피해를 입히고, 이 중 {p7}는 <truedamage>고정 피해</truedamage>로 적용됩니다.<br><br><rules>이 스킬은 피해를 입힐 때 효과가 발동합니다.</rules>", // 정확성 프로토콜
        ...
        "E": "카밀이 지형에 걸리는 갈고리를 발사해 1초 동안 자신을 지형으로 끌어당깁니다. 이 스킬은 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시:</recast> 카밀이 지형으로부터 도약해 처음 마주치는 적 챔피언과 충돌합니다. 충돌 시 {p1}초 동안 <attackspeed>공격 속도가 {p2}%</attackspeed> 증가하고 주변 적에게 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 입히며 적 챔피언을 {p4}초 동안 <status>기절</status>시킵니다. 적 챔피언을 향해 도약할 경우 도약 거리가 두 배로 증가합니다.", // 갈고리 발사
    ...
    "Kaisa": { // 카이사
        "P": "기본 공격 시 {p1}초 동안 <keywordmajor>플라즈마</keywordmajor> 중첩을 쌓고 <magicdamage>중첩당 {p2}+{p3}의 마법 피해</magicdamage>를 추가로 입힙니다. {p4}회 중첩이 쌓인 적을 공격하면 <keywordmajor>플라즈마</keywordmajor>를 소모하며, <magicdamage>대상이 잃은 체력의 {p5}에 해당하는 마법 피해</magicdamage>를 입힙니다. 주변 아군이 적 챔피언을 <status>이동 불가</status> 상태로 만들면 중첩을 {p6}회 적용합니다.<br><br>카이사의 피부가 능력치에 따라 기본 스킬을 진화시킵니다.<br><spellname>이케시아 폭우</spellname>: <physicaldamage>추가 공격력 {p7}/@spell.KaisaQ:Effect6Amount@</physicaldamage><br><spellname>공허추적자</spellname>: <scaleap>주문력 {p8}/@spell.KaisaW:Effect2Amount@</scaleap><br><spellname>고속 충전</spellname>: <attackspeed>추가 공격 속도 {p9}%/@spell.KaisaE:Effect6Amount@%</attackspeed>", // 두 번째 피부 — stringtable
        "Q": "카이사가 근처 적들을 추격하는 미사일을 {p1}개 발사하며, 적중한 적에게 각각 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다. (최대 {p3}) 이미 미사일에 맞은 적 챔피언 또는 몬스터에게 추가 적중할 경우 {p4}%의 피해를 입힙니다.<br><br><keywordmajor>진화 시</keywordmajor>: 미사일을 {p5}개 발사합니다.<br>현재: <physicaldamage>추가 공격력 {p6}/{p7}</physicaldamage>", // 이케시아 폭우
        "W": "카이사가 공허 에너지 광선을 발사해 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 <keywordmajor>플라즈마</keywordmajor> 중첩을 {p2}회 적용하며, @spell.KaisaPassive:PDuration@초 동안 처음으로 적중한 적에 대한 <keywordstealth>절대 시야</keywordstealth>를 얻습니다.<br><br><keywordmajor>진화 시</keywordmajor>: <keywordmajor>플라즈마</keywordmajor> 중첩을 {p3}회 적용합니다. 챔피언 적중 시 재사용 대기시간이 {p4}% 감소합니다.<br>현재: <scaleap>주문력 {p5}/{p6}</scaleap>", // 공허추적자
        "E": "카이사가 공허 에너지를 고속 충전하여 <speed>이동 속도가 {p1}</speed> 증가하고 충전 중에는 유체화 상태가 되며, {p2}초 동안 <attackspeed>공격 속도가 {p3}%</attackspeed> 증가합니다.<br><br>기본 공격 시 스킬의 재사용 대기시간이 {p4}초 감소합니다.<br><br><keywordmajor>진화 시</keywordmajor>: {p5}초 동안 <keywordstealth>투명</keywordstealth> 상태가 됩니다.<br>현재: <attackspeed>추가 공격 속도 {p6}%/{p7}%</attackspeed>", // 고속 충전
    ...
    "Khazix": { // 카직스
        ...
        "R": "<active>사용 시:</active> 카직스가 {p1}초 동안 <keywordstealth>투명</keywordstealth> 상태가 되고 <speed>이동 속도가 {p2}%</speed> 상승합니다. {p3}초 안에 이 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br><passive>기본 지속 효과:</passive> 이 스킬을 레벨 업하면 <evolve>진화</evolve>를 통해 스킬 하나에 추가 효과를 부여합니다.<li><spellname>공포 감지:</spellname> 스킬 및 기본 공격 사거리가 늘어나고 <keywordmajor>고립</keywordmajor>된 대상에게 사용 시 재사용 대기시간이 @spell.KhazixQ:Effect4Amount@% 감소합니다.<li><spellname>공허의 가시:</spellname> 가시를 세 개 발사하고 적을 @spell.KhazixW:Effect3Amount@% <status>둔화</status>합니다. <keywordmajor>고립</keywordmajor>된 대상에게는 효과가 증가합니다.<li><spellname>도약:</spellname> 사거리가 늘어나고 챔피언 처치 관여 시 재사용 대기시간이 초기화됩니다.<li><spellname>공허의 습격:</spellname> {p4}초 동안 <keywordstealth>투명</keywordstealth> 상태가 되고 2회 <recast>재사용</recast>할 수 있습니다.", // 공허의 습격
    },
    "Katarina": { // 카타리나
        "P": "카타리나가 피해를 입힌 챔피언이 {p1}초 내에 죽을 때마다 카타리나의 스킬 재사용 대기시간이 {p2}초 감소합니다.<br><br>카타리나가 <keywordmajor>단검</keywordmajor>을 다시 주우면 근처의 적을 모두 공격해 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다.", // 탐욕 — stringtable
    ...
    "Kalista": { // 칼리스타
        "P": "{{Spell_KalistaP_Tooltip_{p1}}}", // 전투 태세 — stringtable
    ...
    "Caitlyn": { // 케이틀린
        "P": "{p1}번째 기본 공격마다 케이틀린이 <keywordmajor>헤드샷</keywordmajor>을 발사합니다. 수풀 안에서 공격하면 <keywordmajor>헤드샷</keywordmajor>에 필요한 기본 공격을 {p2}회 한 것으로 간주합니다.<br><br><keywordmajor>헤드샷</keywordmajor>은 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 추가로 입힙니다. <spellname>90구경 투망</spellname> 및 <spellname>요들잡이 덫</spellname>에 적중한 적을 대상으로 할 때는 사거리가 두 배로 늘어납니다. <spellname>요들잡이 덫</spellname>에 적중한 적을 대상으로 <keywordmajor>헤드샷</keywordmajor>은 <physicaldamage>@spell.CaitlynW:HeadshotBonusDamage@의 물리 피해</physicaldamage>를 추가로 입힙니다.", // 헤드샷 — stringtable
    ...
    "Kayn": { // 케인
        "P": "{{ game_spell_Kayn_P_main_{p1} }}", // 다르킨의 낫 — stringtable
        "Q": "케인이 돌진한 후 낫을 휘둘러 통과한 적에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힌 다음 주변 적에게 다시 같은 피해를 입힙니다.<br><br><keywordmajor>다르킨 학살자:</keywordmajor> <physicaldamage>{p2}+최대 체력의 {p3}에 해당하는 물리 피해</physicaldamage>를 입힙니다.", // 살상돌격
        "W": "케인이 낫을 위로 휘둘러 적에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입히고 {p2}% <status>둔화</status>시킵니다. 둔화 효과는 {p3}초에 걸쳐 사라집니다.<br><br><keywordmajor>그림자 암살자:</keywordmajor> 케인이 이 스킬을 사용하면서 이동하여 사거리를 늘릴 수 있습니다.<br><br><keywordmajor>다르킨 학살자:</keywordmajor> 또한 적중한 적을 {p4}초 동안 <status>공중으로 띄워 올립니다</status>.", // 몰아치는 낫
        "E": "케인이 {p1}초 동안 유체화 상태가 되어 <speed>이동 속도가 {p2}%</speed> 증가하며 지형을 통과할 수 있습니다. 처음으로 지형을 통과하면 <healing>체력을 {p3}</healing>만큼 회복합니다.<br><br><status>이동 불가</status> 상태가 되거나 지형 밖에서 {p4}초 넘게 머무르면 이 스킬이 즉시 종료됩니다.<br><br><keywordmajor>그림자 암살자:</keywordmajor> <speed>이동 속도가 {p5}%</speed> 증가하고 <status>둔화</status>에 면역이 되며 재사용 대기시간이 {p6}초로 감소합니다.", // 그림자의 길
        "R": "<passive>기본 지속 효과:</passive> 케인이 피해를 입힌 챔피언에게 3.15초 동안 표식을 남깁니다.<br><br>케인이 표식이 남은 적에게 파고들어 대상으로 지정할 수 없게 됩니다. {p1}초가 지나거나 <recast>재사용</recast>하면 케인이 빠져나오면서 적에게 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다.<br><br><keywordmajor>그림자 암살자:</keywordmajor> 이 스킬의 사거리, 즉 케인이 빠져나오는 거리가 증가하며 빠져나올 때 <spellname>다르킨의 낫</spellname> 재사용 대기시간이 초기화됩니다.<br><br><keywordmajor>다르킨 학살자:</keywordmajor> <physicaldamage>최대 체력의 {p3}에 해당하는 물리 피해</physicaldamage>를 입히고 <healing>체력을 {p4}</healing> 회복합니다. (피해량의 {p5}%)", // 그림자의 지배
    },
    "Kayle": { // 케일
        ...
        "E": "<passive>기본 지속 효과:</passive> 기본 공격이 <magicdamage>{p1}의 마법 피해</magicdamage>를 추가로 입힙니다.<br><br><active>사용 시:</active> 케일의 다음 공격 사거리가 증가하며 <magicdamage>대상이 잃은 체력의 {p2}만큼 마법 피해</magicdamage>를 추가로 입힙니다. 이 공격은 케일이 <scalelevel>@Spell.KaylePassive:LevelForPassiveRank2@레벨</scalelevel>에 도달하면 대상에게 적중 시 폭발하여 주변 적에게 피해를 입힙니다.", // 화염주문검
    ...
    "Quinn": { // 퀸
        ...
        "R": "퀸이 발러를 불러 자신을 돕게 합니다. 2초간 정신 집중 후 둘은 하나가 되어 <speed>이동 속도가 {p1}%</speed> 증가하고 이 스킬을 <recast>재사용</recast>할 수 있게 됩니다. 공격하거나 <spellname>실명 공격</spellname> 또는 <spellname>공중제비</spellname> 스킬을 사용하면 이 스킬이 자동으로 <recast>재사용</recast>됩니다.<br><br><recast>재사용 시</recast>: 퀸과 발러가 공중에서 강습해 적 챔피언에게 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입히고 <keywordmajor>매사냥</keywordmajor> 표식을 남긴 후 스킬을 종료합니다.", // 후방 지원
    },
    "KSante": { // 크산테
        ...
        "R": "크산테가 엔토포를 부숴 적 챔피언을 <status>뒤로 밀어내고</status> <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힌 후 적 챔피언 뒤로 돌진하며 {p2}초 동안 <keywordmajor>총공세</keywordmajor> 상태에 돌입합니다. 벽에 부딪힌 적은 벽을 뚫고 <status>뒤로 밀려나며</status> 크산테가 다시 공격해 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 입힙니다.<br><br><keywordmajor>총공세</keywordmajor> 상태에서는 크산테의 스킬이 업그레이드되며 크산테의 <attackspeed>공격 속도가 {p4}%</attackspeed>, 추가 방어구 관통력이 {p5}%, <omnivamp>모든 피해 흡혈이 {p6}%</omnivamp> 증가하지만 <healing>최대 체력이 {p7}%</healing>, <scalearmor>추가 방어력이 {p8}%</scalearmor>, <scalemr>추가 마법 저항력이 {p8}%</scalemr> 감소합니다.", // 총공세
    },
    "Kled": { // 클레드
        "P": "<keywordmajor>탑승 시:</keywordmajor> 클레드 대신 스칼이 피해를 입습니다. 스칼의 체력이 소진되면 클레드가 스칼에게서 내립니다.<br><br><keywordmajor>미탑승 시:</keywordmajor> 클레드의 <spellname>덫날리기</spellname> 스킬이 변경되고 적 챔피언을 향해 이동할 때 <speed>이동 속도가 {p1}</speed> 증가합니다. 또한 {p2}의 추가 <scalearmor>방어력</scalearmor> 및 <scalemr>마법 저항력</scalemr>을 얻으며, 이 수치는 주변 적 챔피언 하나당 {p3}% 증가해 최대 {p4}까지 증가합니다. 미탑승 상태에서 클레드의 기본 공격은 챔피언에게 {p5} 감소한 피해를 입힙니다.<br><br>클레드가 챔피언을 공격하면 <keywordmajor>{p6}의 용기</keywordmajor>, 에픽 몬스터와 구조물을 공격하면 <keywordmajor>{p7}의 용기</keywordmajor>, 미니언을 처치하면 <keywordmajor>{p8}의 용기</keywordmajor>를 얻습니다. <keywordmajor>용기</keywordmajor>가 최대로 쌓이면 클레드가 {p9}초에 한 번씩 스칼 체력의 {p10}만큼을 가지고 스칼 위에 다시 탑승합니다.", // 겁쟁이 도마뱀 스칼 — stringtable
    ...
    "Qiyana": { // 키아나
        ...
        "Q": "무기에 <keywordmajor>원소의 힘</keywordmajor>이 없으면 무기를 휘두르며 좁은 영역에 있는 적들에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다. <keywordmajor>원소의 힘</keywordmajor>에 따라 사거리가 증가하고 추가 효과를 얻습니다.<li><keywordmajor>얼음의 힘</keywordmajor>: 적들을 잠시 동안 <status>속박</status>한 다음 {p2}초 동안 {p3}%만큼 <status>둔화</status>시킵니다.<li><keywordmajor>바위의 힘</keywordmajor>: 체력이 {p4}%보다 낮은 적에게 <physicaldamage>{p5}의 추가 물리 피해</physicaldamage>를 입힙니다.<li><keywordmajor>야생의 힘</keywordmajor>: <keywordstealth>투명</keywordstealth> 상태가 되고 <speed>이동 속도가 {p6}%</speed> 상승하는 영역을 생성합니다.<br>", // 원소의 분노 / 이쉬탈의 칼날
    ...
    "Taliyah": { // 탈리야
        ...
        "Q": "탈리야가 5개의 바위 조각을 던져 처음으로 맞힌 적 주변 지역에 개당 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 땅을 다집니다. 동일한 적에게 연달아 바위 조각을 맞힐 경우 피해량이 {p2}% 감소합니다.<br><br>다져진 땅에서 이 스킬을 사용하면 마나가 {p3} 소모되며 재사용 대기시간이 {p4}% 감소하고 다져진 땅을 소모해 바위를 던집니다. 바위는 적중한 적을 {p5}초 동안 {p6}% <status>둔화</status>시키고 첫 번째 대상에게 <magicdamage>{p7}의 마법 피해</magicdamage>를 입힙니다. 바위에 맞은 몬스터는 {p8}초 동안 <status>기절</status>합니다.", // 파편 난사
        ...
        "R": "탈리야가 {p1}초 동안 거대한 흙벽을 세웁니다. 즉시 <recast>재사용</recast>하면 움직이는 벽에 올라타며, 이동하거나 이동 불가 효과에 걸리면 벽에서 내려옵니다.<br><br>탈리야가 지난 {p2}초 안에 챔피언 또는 구조물에 의한 피해를 입었으면 이 스킬을 사용할 수 없습니다.", // 바위술사의 벽
    },
    "TahmKench": { // 탐 켄치
    ...
    "TwistedFate": { // 트위스티드 페이트
        "P": "{{ Spell_SecondSight_Tooltip_{p1} }}", // 사기 주사위 — stringtable
        "Q": "트위스티드 페이트가 카드 세 장을 던져 각각 <magicdamage>{p1}의 마법 피해</magicdamage>를 입힙니다.", // 와일드 카드
        "W": "트위스티드 페이트가 덱을 섞고 <recast>재사용</recast>하면 세 카드 중 하나를 정해 다음 기본 공격을 강화합니다.<br><li>푸른색 카드는 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 <scalemana>마나를 {p2}</scalemana> 회복시킵니다.<li>붉은색 카드는 주변 적에게 <magicdamage>{p3}</magicdamage>의 피해를 입히고 2.5초 동안 {p4}% <status>둔화</status>시킵니다.<li>황금색 카드는 <magicdamage>{p5}</magicdamage>의 피해를 입히고 {p6}초 동안 <status>기절</status>시킵니다.", // 카드 뽑기
        ...
        "R": "트위스티드 페이트가 카드에 집중하여 {p1}초 동안 맵에 있는 모든 적 챔피언에 대한 <keywordstealth>절대 시야</keywordstealth>를 얻고 해당 스킬을 <recast>재사용</recast>할 수 있습니다.<br><br><recast>재사용 시</recast>: 트위스티드 페이트가 최대 {p2}의 거리만큼 순간이동합니다.", // 운명
    },
    "Twitch": { // 트위치
    ...
    "Pantheon": { // 판테온
        ...
        "Q": "<font color='#FF8C00'>짧게 누를 때:</font> 판테온이 창을 찔러 적중한 적들에게 <physicaldamage>{p1}의 물리 피해</physicaldamage>를 입힙니다. 혜성의 창 재사용 대기시간이 {p2}% 감소합니다.<br><br><font color='#FF8C00'>길게 누를 때:</font> 판테온이 창을 던져 처음 적중한 적에게 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 입히고 뒤에 있는 적들에게 {p4}% 감소된 피해를 입힙니다. <br><br>체력이 {p5}% 아래인 적들에게는 스킬이 강화되어 <physicaldamage>{p6}의 물리 피해</physicaldamage>를 입힙니다.<br><br><font color='#EDDA74'>필멸자의 의지 추가 효과:</font> <physicaldamage>{p7}의 물리 피해</physicaldamage>를 추가로 입힙니다.", // 혜성의 창
        "W": "판테온이 대상에게 도약한 뒤 {p1}초 동안 대상을 <status>기절</status>시키고 <physicaldamage>최대 체력의 {p2}에 해당하는 물리 피해</physicaldamage>를 입힙니다.<br><br><keywordmajor>필멸자의 의지 추가 효과:</keywordmajor> 판테온의 다음 기본 공격이 {p3}회 타격하여 총 <physicaldamage>{p4}의 물리 피해</physicaldamage>를 입힙니다.", // 방호의 도약
        "E": "판테온이 방패를 들어 지정한 방향의 적들과 전투를 시작합니다. {p1}초 동안 포탑을 제외한 해당 방향의 피해로부터 면역이 되고 <physicaldamage>{p2}의 물리 피해</physicaldamage>를 입힙니다. 지속시간이 끝나면 판테온이 방패로 타격하며 <physicaldamage>{p3}의 물리 피해</physicaldamage>를 입힙니다.<br><br><font color='#EDDA74'>필멸자의 의지 추가 효과:</font> 방패로 타격할 때 {p4}초 동안 <scalearmor>방어력이 {p5}</scalearmor>, <scalemr>마법 저항력이 {p5}</scalemr> 상승하고 {p6}초 동안 <speed>이동 속도가 {p7}%</speed> 상승합니다. <br>", // 방패 돌격
        "R": "<passive>기본 지속 효과:</passive> 판테온의 방어구 관통력이 {p1}% 증가합니다.<br><br><active>사용 시:</active> 판테온이 힘을 모아 높이 도약했다가 창을 던져 좁은 영역에 <physicaldamage>@spell.PantheonQ:HoldDamageCalc@의 물리 피해</physicaldamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다. <br><br>그런 다음 지정한 위치에 유성이 되어 떨어집니다. 일직선상에 있는 적들에게 최대 <magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다. (피해량은 범위 가장자리로 갈수록 감소하여 가장 바깥쪽은 {p5}% 감소된 피해를 입힙니다.)<br><br>이 스킬을 사용하면 <font color='#EDDA74'>필멸자의 의지</font>가 즉시 활성화됩니다.", // 거대 유성
    },
    "FiddleSticks": { // 피들스틱
        ...
        "Q": "<passive>기본 지속 효과:</passive> 전투에서 벗어나 적의 시야에 보이지 않을 때나 <keywordmajor>허수아비</keywordmajor>인 척할 때 적에게 스킬로 피해를 입히면 대상이 {p1}초 동안 <status>공포</status>에 질립니다.<br><br><active>사용 시:</active> {p1}초 동안 적을 <status>공포</status>에 빠트리고 <magicdamage>현재 체력의 {p2}에 해당하는 마법 피해</magicdamage>를 입힙니다. 최근에 피들스틱에 의해 <status>공포</status>에 빠진 대상은 <magicdamage>현재 체력의 {p3}에 해당하는 마법 피해</magicdamage>를 입습니다.<br>", // 공포
    ...
    "Fiora": { // 피오라
        "P": "피오라가 적 챔피언의 <keywordmajor>급소</keywordmajor>를 찾아냅니다. 기본 공격이나 스킬로 이 <keywordmajor>급소</keywordmajor>를 가격하면 <truedamage>최대 체력에 비례해 {p1}의 고정 피해</truedamage>를 추가로 입히며 피오라의 <speed>이동 속도가 @spell.FioraR:PercentMS*100@%</speed> 상승했다가 {p2}초에 걸쳐 원래대로 돌아오고 <healing>체력을 {p3}</healing> 회복합니다.<br><br>15초가 지나거나 피오라가 급소를 가격하면 새로운 <keywordmajor>급소</keywordmajor>가 드러납니다.", // 치명적인 검무 — stringtable
        ...
        "R": "<passive>기본 지속 효과:</passive> <spellname>치명적인 검무</spellname> <speed>이동 속도</speed> 추가 효과가 {p1}%로 상승합니다.<br><br><active>사용 시:</active> 피오라가 챔피언의 <keywordmajor>급소</keywordmajor> 네 군데를 다 드러내 <truedamage>최대 체력의 @spell.FioraPassive:RDamageTotal@에 해당하는 고정 피해</truedamage>를 최대로 입히고 대상 근처에서 <spellname>치명적인 검무</spellname>의 <speed>이동 속도</speed> 상승 효과를 얻습니다.<br><br>피오라가 {p2}초 내에 <keywordmajor>급소</keywordmajor> 네 군데를 모두 가격하거나 한 번이라도 급소를 공격한 뒤 대상이 사망할 경우, 주변 아군 챔피언은 {p3}초 동안 <healing>초당 체력을 {p4}</healing>씩 회복합니다.", // 대결투
    },
    "Fizz": { // 피즈
        ...
        "E": "피즈가 삼지창 위에 서고 0.75초 동안 대상으로 지정할 수 없는 상태가 됩니다. 이후 근처 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 {p3}% <status>둔화</status>시킵니다. <br><br>피즈가 대상으로 지정할 수 없는 상태에서 이 스킬을 <recast>재사용</recast>하면 다시 돌진하면서 효과가 일찍 끝나며 보다 작은 지역에 피해를 입히고 <status>둔화</status> 효과를 적용하지 않습니다.", // 장난치기 / 재간둥이
    ...
    "Heimerdinger": { // 하이머딩거
        ...
        "R": "하이머딩거가 다음에 사용하는 궁극기 이외의 스킬을 강화합니다.<br><br><spellname>H-28Q 최첨단 포탑:</spellname> 하이머딩거의 최대 포탑 개수에 포함되지 않는 강화된 <keywordmajor>포탑</keywordmajor>을 8초 동안 배치해 기본 사격마다 <magicdamage>{p1}의 마법 피해</magicdamage>, 충전 사격마다 <magicdamage>{p2}의 마법 피해</magicdamage>를 입힙니다. 포탑 공격은 대상 지역에 피해를 입히며, 2초 동안 25% <status>둔화</status>시킵니다. 포탑은 군중 제어기에 면역이 됩니다.<br><br><spellname>마법공학 로켓 연사:</spellname> 로켓이 4회 연속 발사되며 각각 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다. 챔피언과 정글 몬스터가 추가 로켓으로 받는 피해량이 감소하고 미니언이 추가 로켓으로 받는 피해량은 증가합니다. 최대 피해량: <magicdamage>{p4}의 마법 피해</magicdamage> <br><br><spellname>CH-3X 전격 수류탄:</spellname> 세 번 튕기며 전류를 방출하는 반동 수류탄을 던져 <magicdamage>{p5}의 마법 피해</magicdamage>를 입힙니다. <status>기절</status>과 <status>둔화</status> 적용 범위가 모두 커집니다.<br><br><recast>재사용 시:</recast> 이 스킬을 취소합니다.", // 업그레이드!!!
    },
    "Hecarim": { // 헤카림
    ...
    "Hwei": { // 흐웨이
        ...
        "Q": "흐웨이가 참사의 환상을 그려내 적에게 막대한 피해를 입힙니다.<br><br><spellname>파멸의 화염</spellname><br>흐웨이가 빠르게 날아가는 불덩이를 날립니다. 불덩이는 처음 적과 적중하면 폭발해 <magicdamage>{p1}+최대 체력의 {p2}%에 해당하는 마법 피해</magicdamage>를 입힙니다.<br><br><spellname>절단의 번개</spellname><br>흐웨이가 멀리 떨어진 대상 지점을 지정하고 잠시 후 벼락을 떨어뜨려 <magicdamage>{p3}의 마법 피해</magicdamage>를 입힙니다. 대상이 고립 또는 <status>이동 불가</status> 상태일 경우 대상이 잃은 체력에 비례해 최대 <magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다.<br><br><spellname>녹아내린 균열</spellname><br>흐웨이가 뻗어나가는 용암 폭발을 일으킵니다. 일정 지역 내 적에게 <magicdamage>{p5}의 마법 피해</magicdamage>를 입히고, 용암 웅덩이를 남겨 @spell.HweiQE:Duration@초 동안 적에게 <magicdamage>매초 {p6}의 마법 피해</magicdamage>를 입히고 @spell.HweiQE:SlowPercent@% <status>둔화</status>시킵니다.", // 주제: 참사
        "W": "흐웨이가 평온의 환상을 그려내 자신과 아군 챔피언에게 이로운 효과를 부여합니다.<br><br><spellname>쏜살같은 물살</spellname><br>흐웨이가 일직선으로 빠르게 흐르는 물을 흘려보내 아군의 <speed>이동 속도를 {p1}</speed> 상승시킵니다.<br><br><spellname>반사의 웅덩이</spellname><br>흐웨이가 보호의 웅덩이를 형성해 영역 안의 아군 챔피언에게 일정 시간에 걸쳐 <shield>{p2}의 피해를 흡수하는 보호막</shield>을 씌웁니다. 단, 아군에게는 보호막 효과가 @spell.HweiWW:ToolTipAllyMod*100@% 감소합니다.<br><br><spellname>요동치는 빛</spellname><br>흐웨이가 소용돌이치는 빛 3개를 만들어 냅니다. 빛은 다음 3회의 스킬 또는 기본 공격 시 <magicdamage>{p3}의 추가 마법 피해</magicdamage>를 입히며, 각각 <scalemana>{p4}의 마나</scalemana>를 회복합니다.", // 주제: 평온
        "E": "흐웨이가 적을 통제하는 고통의 환상을 그려냅니다.<br><br><spellname>암울한 형상</spellname><br>흐웨이가 무시무시한 얼굴을 날려 처음 적중한 적에게 <magicdamage>{p1}의 마법 피해</magicdamage>를 입히고 {p2}초 동안 <status>도망</status>치게 합니다.<br><br><spellname>심연의 응시</spellname><br>흐웨이가 지정한 위치에 남아 시야를 확보하는 눈을 만들어 냅니다. 눈은 사거리 내로 처음 들어오는 적 챔피언에게 유도 발사체를 날려 처음 적중한 대상을 {p3}초 동안 <status>속박</status>하고 <magicdamage>{p4}의 마법 피해</magicdamage>를 입힙니다.<br><br><spellname>파괴의 아귀</spellname><br>흐웨이가 지정한 위치에 파괴의 아귀를 그려내 적을 중앙으로 <status>끌어당깁니다</status>. 파괴의 아귀는 적중한 적에게 <magicdamage>{p5}의 마법 피해</magicdamage>를 입히고 {p6}% <status>둔화</status>시킵니다. 둔화 효과는 1.25초에 걸쳐 사라집니다.", // 주제: 고통
