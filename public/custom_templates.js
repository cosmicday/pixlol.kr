...
const customTemplates = {
    ...
    "Aphelios": { // 아펠리오스
        "P": "아펠리오스는 쌍둥이 누이 알룬이 만든 다섯 가지의 루나리 무기를 사용합니다. 한 번에 주 무기와 보조 무기 등 총 두 가지 무기를 사용할 수 있습니다. 각 무기는 고유의 기본 공격 및 [Q] 스킬을 가지고 있습니다. 기본 공격과 스킬 사용 시 탄약을 소모하며, 탄약을 모두 소모하면 사용 중인 주 무기를 다음 무기로 교체합니다. <br><br>2레벨 도달 시 [Q] 스킬을 사용할 수 있으며 6레벨 도달 시 궁극기를 사용할 수 있습니다. 아펠리오스는 스킬 포인트로 스킬 레벨을 올리는 대신 영구 능력치를 획득합니다.", // 암살자와 예언자 — stringtable. [{p1}] 은 무기 스킬 핫키라 [Q] 로 고정, 끝의 "루나리 무기 순서" 블록 제거 (게임 중 계속 바뀌는 현재 상태값 + 중첩형 {{키_{pN}}} 이라 정적 조회 불가)
        "Q": "", // 무기 스킬
