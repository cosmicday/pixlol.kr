...
const KNOWN_OK = new Map([
    ...
    // 2026-08-24 밤 — 롤위키·나무위키 일치 + 패치노트로 정정한 투사체 (괄호 붙은 둘만 fromWiki 를 못 탄다)
    ['시비르 Q', '투사체 1450 (돌아올 때 1200) — 12.13 패치노트 1350→1450, 나무위키 일치'],
    ['쉬바나 E', '투사체 1600 (용 형태 1575) — 26.06 리워크 패치노트'],
