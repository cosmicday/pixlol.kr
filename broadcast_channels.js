...
module.exports = {
    ...
    streamers: [
        ...
        // ---- 2026-09-17 밤 3차 — 나무위키 문서에서 뽑아 라이엇 API 로 검증 (215명 훑어 셋 나옴, 그중 둘이 랭크 계정) ----
        { p: 'chzzk', ch: '8a59b34b46271960c1bf172bb0fac758', name: '앰비션', ex: 'Gen.G', riot: ['QQQ Ambition#Basic'] },
        { p: 'chzzk', ch: 'b628d1039a84ecc703804e17acee2eb3', name: '크캣', riot: ['Crazycat#66666', 'CrazyCat88#KR1', 'CrazyCat33#KR1'] },
        // ★ 못 찾은 사람 (deeplol 미등록 · 나무위키에도 태그 없음): 노페 · 김군 · 도파(문서의 계정은 본인 것이 아니라고 적혀 있다) · 디나이05 · 챌린저카인 · 미키 · 스피릿 · 태평창 · 스오 · 희태시기(유튜브 채널 ID 미확인, 계정은 희태시기#КR1 — 태그의 К 가 키릴 문자다)
